...
&НаКлиенте
Процедура ДекорацияИсторияКассыНажатие(Элемент)
	
	ОткрытьФорму("РегистрСведений.ОрганизацииКассы.ФормаСписка", 
		Новый Структура("Отбор", 
			Новый Структура("Организация", Объект.Ссылка)
		)
	);
...
&НаКлиенте
Процедура ДекорацияИсторияРасположенияНажатие(Элемент)
	
	ОткрытьФорму("РегистрСведений.РасположениеФирм.ФормаСписка", 
		Новый Структура("Отбор", 
			Новый Структура("Организация", Объект.Ссылка)
		)
	);
...
&НаКлиенте
Процедура ДекорацияИсторияСвязиНажатие(Элемент)
	
	ОткрытьФорму("РегистрСведений.СвязьОрганизаций8ИСчетов7.ФормаСписка", 
		Новый Структура("Отбор", 
			Новый Структура("Организация8", Объект.Ссылка)
		)
	);
...
&НаСервере
Процедура ПолучитьДанныеКассы()

	ДанныеКассы = РегистрыСведений.ОрганизацииКассы.ПолучитьДанныеКассыОрганизации(Объект.Ссылка, ТекущаяДатаСеанса());
	Касса = ДанныеКассы.СчетКассы;
