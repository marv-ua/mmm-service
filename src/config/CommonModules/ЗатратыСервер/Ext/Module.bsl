...
Процедура СформироватьЭтотОтчет(ПараметрыОтчета, АдресХранилища) Экспорт
	...
	Итоги.ОстаткиОборотыОбщ.Колонки.Добавить("СуммаНачало");
	Итоги.ОстаткиОборотыОбщ.Колонки.Добавить("СуммаКонец");
	Итоги.ОстаткиОборотыОбщ.Колонки.Добавить("СуммаПриход");
	Итоги.ОстаткиОборотыОбщ.Колонки.Добавить("СуммаРасход");
	Итоги.ОстаткиОборотыОбщ.Колонки.Добавить("ДатаНач");
	Итоги.ОстаткиОборотыОбщ.Колонки.Добавить("ДатаКон");
	Итоги.ОстаткиОбороты.Колонки.Добавить("СуммаНачало");
	Итоги.ОстаткиОбороты.Колонки.Добавить("СуммаКонец");
	Итоги.ОстаткиОбороты.Колонки.Добавить("СуммаПриход");
	Итоги.ОстаткиОбороты.Колонки.Добавить("СуммаРасход");
	Итоги.ОстаткиОбороты.Колонки.Добавить("Фирма");
	Итоги.ОстаткиОбороты.Колонки.Добавить("ПриходКасса");
	Итоги.ОстаткиОбороты.Колонки.Добавить("ПриходРеализация");
	Итоги.ОстаткиОбороты.Колонки.Добавить("ПриходУчредит");
	Итоги.ОстаткиОбороты.Колонки.Добавить("ПриходУниверс");
	Итоги.ОстаткиОбороты.Колонки.Добавить("ПриходОфис");
	Итоги.ОстаткиОбороты.Колонки.Добавить("ПриходМальч");
	Итоги.ОстаткиОбороты.Колонки.Добавить("ПриходВНД");
	Итоги.ОстаткиОбороты.Колонки.Добавить("Приход57");
	Итоги.ОстаткиОбороты.Колонки.Добавить("ПриходВозврат");
	Итоги.ОстаткиОбороты.Колонки.Добавить("ПриходСТорно");
	Итоги.ОстаткиОбороты.Колонки.Добавить("ПриходМатериалы");
	Итоги.ОстаткиОбороты.Колонки.Добавить("ПриходПрочие");
	Итоги.ОстаткиОбороты.Колонки.Добавить("ИтогоПриход");
	Итоги.ОстаткиОбороты.Колонки.Добавить("ПроверкаПриход");
	Итоги.ОстаткиОбороты.Колонки.Добавить("РасходКасса");
	Итоги.ОстаткиОбороты.Колонки.Добавить("РасходНалоги");
	Итоги.ОстаткиОбороты.Колонки.Добавить("РасходЗП");
	Итоги.ОстаткиОбороты.Колонки.Добавить("РасходУслуги");
	Итоги.ОстаткиОбороты.Колонки.Добавить("РасходТовар");
	Итоги.ОстаткиОбороты.Колонки.Добавить("РасходМатериалы");
	Итоги.ОстаткиОбороты.Колонки.Добавить("РасходУниверс");
	Итоги.ОстаткиОбороты.Колонки.Добавить("РасходПринципалы");
	Итоги.ОстаткиОбороты.Колонки.Добавить("РасходОфис");
	Итоги.ОстаткиОбороты.Колонки.Добавить("РасходМальч");
	Итоги.ОстаткиОбороты.Колонки.Добавить("Расход57");
	Итоги.ОстаткиОбороты.Колонки.Добавить("РасходПрочие");
	Итоги.ОстаткиОбороты.Колонки.Добавить("ИтогоРасход");
	Итоги.ОстаткиОбороты.Колонки.Добавить("ПроверкаРасход");
	
	Итоги.ОборотыПоСтатьям.Колонки.Добавить("Оплата");
	Итоги.ОборотыПоСтатьям.Колонки.Добавить("Поступления");
	Итоги.ОборотыПоСтатьям.Колонки.Добавить("СуммаПриход");
	Итоги.ОборотыПоСтатьям.Колонки.Добавить("СуммаРасход");
	Итоги.ОборотыМальч.Колонки.Добавить("СуммаПриход");
	Итоги.ОборотыМальч.Колонки.Добавить("СуммаРасход");
	Итоги.ОборотыМальч.Колонки.Добавить("Фирма");
	Итоги.ОборотыОфис.Колонки.Добавить("СуммаПриход");
	Итоги.ОборотыОфис.Колонки.Добавить("СуммаРасход");
		...
		Если Ответ.Результат.Количество() > 0 Тогда
			...
			Для Каждого Стр Из ТаблицаУслуг2 Цикл
				Если Не ЗначениеЗаполнено(Стр.ВидНалога) Тогда
					...
					// итоги
					Если Стр.ТипКлиента = "Офис" Тогда
						НоваяСтрока = ПараметрыОтчета.Итоги.ОборотыОфис.Добавить();
						НоваяСтрока.Фирма = Организация;
	...
	Если НЕ Ответ.Ошибка Тогда
		Если Ответ.Результат.Количество() > 0 Тогда
			...
			Для Каждого Стр Из ТаблицаПоступлений Цикл
				...
				ИначеЕсли (Лев(Стр.КорСчет, 2) = "62" 		// ПриходВНД
				...
				ИначеЕсли Лев(Стр.КорСчет, 2) = "60"		// ПриходВозврат
					И ПараметрыОтчета.СвоиФирмы.Найти(Стр.КорСубконтоИНН, "ИНН") = Неопределено
					И СтрНайти(ВРег(Стр.КорСубконто), "РЕКЛ") = 0
					И СтрНайти(ВРег(Стр.КорСубконто), "ТИМОША") = 0
					И СтрНайти(ВРег(Стр.КорСубконто), "БЛЕЙД") = 0 Тогда
					НоваяСтрока = ПараметрыОтчета.Итоги.ОстаткиОбороты.Добавить();
					НоваяСтрока.Фирма = СокрЛП(Организация);
					НоваяСтрока.ПриходВозврат = Стр.СуммаПрихода;
					
				ИначеЕсли Не Лев(Стр.КорСчет, 2) = "57" И Не Лев(Стр.КорСчет, 2) = "60"	// ПриходРеализация
					И ПараметрыОтчета.СвоиФирмы.Найти(Стр.КорСубконтоИНН, "ИНН") = Неопределено
					И СтрНайти(ВРег(Стр.КорСубконто), "ТИМОША") = 0
					И СтрНайти(ВРег(Стр.КорСубконто), "БЛЕЙД") = 0 Тогда
					НоваяСтрока = ПараметрыОтчета.Итоги.ОстаткиОбороты.Добавить();
				...
				ИначеЕсли Не Лев(Стр.КорСчет, 2) = "57"   							// ПриходУниверс
			...
			Для Каждого Стр Из ТаблицаПокупателей Цикл
				Если Не ЗначениеЗаполнено(Стр.Контрагент) Тогда
					...
					Если Стр.ТипКлиента = "Офис" Тогда
						...
						НоваяСтрока.Фирма = СокрЛП(Организация);
						НоваяСтрока.ПриходОфис = Стр.СуммаПрихода;
					ИначеЕсли Стр.ТипКлиента = "Фирмы универсама" Тогда
						НоваяСтрока = ПараметрыОтчета.Итоги.ОстаткиОбороты.Добавить();
						НоваяСтрока.Фирма = СокрЛП(Организация);
						НоваяСтрока.ПриходУниверс = Стр.СуммаПрихода;
					КонецЕсли;
