...
Функция СформироватьТабличноеПредставление(Прокси, ПараметрыОтчета, Организация, ТабличныйДокумент, Макет, Группа, ДанныеВыборки, НомерПП) Экспорт
	...
	ИтСуммаВсегоПоВсем = ИтогоСуммаЗПИЛНалоги + ТаблицаУслуг.Итог("СуммаУслуг") + ТаблицаМатериалов.Итог("СуммаОплатМатериалов") + ИтСуммаДоп;
...
Процедура КонтрагентыДополнительныеРеквизиты(Прокси, ПараметрыОтчета, Организация, ТабличныйДокумент, Макет, ИтСуммаДоп, Курс)
