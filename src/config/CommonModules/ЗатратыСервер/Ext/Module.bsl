...
Процедура СформироватьЭтотОтчет(ПараметрыОтчета, АдресХранилища) Экспорт
	...
	Пока ТекПериод < КонецПериода Цикл
		ПараметрыОтчета.НачалоПериода = ТекПериод;
		ПараметрыОтчета.КонецПериода = КонецМесяца(ТекПериод);

		ТаблицаОрганизаций = мммСервер.ПолучитьТаблицуСерверов(ПараметрыОтчета.НачалоПериода, ПараметрыОтчета.Организация);
		ТаблицаОрганизаций.Сортировать("Бухгалтер,Наименование");
		...
		Итоги.Вставить("ОстаткиОборотыОбщ", Новый ТаблицаЗначений);
		Итоги.Вставить("ОстаткиОбороты", Новый ТаблицаЗначений);
		Итоги.Вставить("ОборотыПоСтатьям", Новый ТаблицаЗначений);
		Итоги.Вставить("ОборотыМальч", Новый ТаблицаЗначений);
		Итоги.Вставить("ОборотыОфис", Новый ТаблицаЗначений);
		Итоги.Вставить("ОборотыМатериалы", Новый ТаблицаЗначений);

		Итоги.ОстаткиОборотыОбщ.Колонки.Добавить("СуммаНачало", ТипЧисло);
		Итоги.ОстаткиОборотыОбщ.Колонки.Добавить("СуммаКонец", ТипЧисло);
		Итоги.ОстаткиОборотыОбщ.Колонки.Добавить("СуммаПриход", ТипЧисло);
		Итоги.ОстаткиОборотыОбщ.Колонки.Добавить("СуммаРасход", ТипЧисло);
		Итоги.ОстаткиОборотыОбщ.Колонки.Добавить("ДатаНач");
		Итоги.ОстаткиОборотыОбщ.Колонки.Добавить("ДатаКон");
		Итоги.ОстаткиОбороты.Колонки.Добавить("СуммаНачало", ТипЧисло);
		Итоги.ОстаткиОбороты.Колонки.Добавить("СуммаКонец", ТипЧисло);
		Итоги.ОстаткиОбороты.Колонки.Добавить("СуммаПриход", ТипЧисло);
		Итоги.ОстаткиОбороты.Колонки.Добавить("СуммаРасход", ТипЧисло);
		Итоги.ОстаткиОбороты.Колонки.Добавить("Фирма");
		Итоги.ОстаткиОбороты.Колонки.Добавить("ПриходКасса", ТипЧисло);
		Итоги.ОстаткиОбороты.Колонки.Добавить("ПриходРеализация", ТипЧисло);
		Итоги.ОстаткиОбороты.Колонки.Добавить("ПриходУчредит", ТипЧисло);
		Итоги.ОстаткиОбороты.Колонки.Добавить("ПриходУниверс", ТипЧисло);
		Итоги.ОстаткиОбороты.Колонки.Добавить("ПриходОфис", ТипЧисло);
		Итоги.ОстаткиОбороты.Колонки.Добавить("ПриходМальч", ТипЧисло);
		Итоги.ОстаткиОбороты.Колонки.Добавить("ПриходВНД", ТипЧисло);
		Итоги.ОстаткиОбороты.Колонки.Добавить("Приход57", ТипЧисло);
		Итоги.ОстаткиОбороты.Колонки.Добавить("ПриходВозврат", ТипЧисло);
		Итоги.ОстаткиОбороты.Колонки.Добавить("ПриходСТорно", ТипЧисло);
		Итоги.ОстаткиОбороты.Колонки.Добавить("ПриходМатериалы", ТипЧисло);
		Итоги.ОстаткиОбороты.Колонки.Добавить("ПриходПрочие", ТипЧисло);
		Итоги.ОстаткиОбороты.Колонки.Добавить("ИтогоПриход", ТипЧисло);
		Итоги.ОстаткиОбороты.Колонки.Добавить("ПроверкаПриход", ТипЧисло);
		Итоги.ОстаткиОбороты.Колонки.Добавить("РасходКасса", ТипЧисло);
		Итоги.ОстаткиОбороты.Колонки.Добавить("РасходНалоги", ТипЧисло);
		Итоги.ОстаткиОбороты.Колонки.Добавить("РасходЗП", ТипЧисло);
		Итоги.ОстаткиОбороты.Колонки.Добавить("РасходУслуги", ТипЧисло);
		Итоги.ОстаткиОбороты.Колонки.Добавить("РасходТовар", ТипЧисло);
		Итоги.ОстаткиОбороты.Колонки.Добавить("РасходМатериалы", ТипЧисло);
		Итоги.ОстаткиОбороты.Колонки.Добавить("РасходУниверс", ТипЧисло);
		Итоги.ОстаткиОбороты.Колонки.Добавить("РасходПринципалы", ТипЧисло);
		Итоги.ОстаткиОбороты.Колонки.Добавить("РасходОфис", ТипЧисло);
		Итоги.ОстаткиОбороты.Колонки.Добавить("РасходМальч", ТипЧисло);
		Итоги.ОстаткиОбороты.Колонки.Добавить("Расход57", ТипЧисло);
		Итоги.ОстаткиОбороты.Колонки.Добавить("Расход51", ТипЧисло);
		Итоги.ОстаткиОбороты.Колонки.Добавить("Приход51", ТипЧисло);
		Итоги.ОстаткиОбороты.Колонки.Добавить("РасходТройств", ТипЧисло);
		Итоги.ОстаткиОбороты.Колонки.Добавить("РасходВетСправка", ТипЧисло);
		Итоги.ОстаткиОбороты.Колонки.Добавить("РасходПрочие", ТипЧисло);
		Итоги.ОстаткиОбороты.Колонки.Добавить("ИтогоРасход", ТипЧисло);
		Итоги.ОстаткиОбороты.Колонки.Добавить("ПроверкаРасход", ТипЧисло);

		Итоги.ОборотыПоСтатьям.Колонки.Добавить("Оплата", ТипЧисло);
		Итоги.ОборотыПоСтатьям.Колонки.Добавить("Поступления", ТипЧисло);
		Итоги.ОборотыПоСтатьям.Колонки.Добавить("СуммаПриход", ТипЧисло);
		Итоги.ОборотыПоСтатьям.Колонки.Добавить("СуммаРасход", ТипЧисло);
		Итоги.ОборотыМальч.Колонки.Добавить("СуммаПриход", ТипЧисло);
		Итоги.ОборотыМальч.Колонки.Добавить("СуммаРасход", ТипЧисло);
		Итоги.ОборотыМальч.Колонки.Добавить("Фирма");
		Итоги.ОборотыОфис.Колонки.Добавить("СуммаПриход", ТипЧисло);
		Итоги.ОборотыОфис.Колонки.Добавить("СуммаРасход", ТипЧисло);
		Итоги.ОборотыОфис.Колонки.Добавить("Фирма");
		Итоги.ОборотыМатериалы.Колонки.Добавить("СуммаПриход", ТипЧисло);
		Итоги.ОборотыМатериалы.Колонки.Добавить("СуммаРасход", ТипЧисло);
		Итоги.ОборотыМатериалы.Колонки.Добавить("Фирма");

		ПараметрыОтчета.Вставить("Итоги", Итоги);
		
		ПараметрыОтчета.Вставить("СвоиФирмы", ПолучитьТаблицуСвоихФирм(, ПараметрыОтчета.КонецПериода));
		ПараметрыОтчета.СвоиФирмы.Индексы.Добавить("Организация");
		/////////////////////////////////////////////////////////

		Для Каждого ВыборкаДетальныеЗаписи Из ТаблицаОрганизаций Цикл
			Если Не ВыборкаДетальныеЗаписи.Пометка Тогда
				Продолжить;
			КонецЕсли;

			ЗаписатьВЛог(ВыборкаДетальныеЗаписи.Ссылка, Лог);

			ДлительныеОперации.СообщитьПрогресс(Окр(100*Прогон/ТаблицаОрганизаций.Количество()), ""+Формат(ПараметрыОтчета.НачалоПериода, "ДФ='MMMM yyyy'")+": "+СокрЛП(ВыборкаДетальныеЗаписи.Ссылка.НаименованиеСокращенное),);
			...
			Попытка
				...
				Для сч = 1 По 3 Цикл
					...
					Исключение
						Если Сч = 3 Тогда
							ЗаписатьВЛог(ВыборкаДетальныеЗаписи.Ссылка, Лог, Истина, ОписаниеОшибки());
				...
				Если НЕ ПараметрыОтчета.НеФормироватьДанныеДляВыгрузки Тогда
					Если НЕ СформироватьПоток(Прокси, ПараметрыОтчета, ВыборкаДетальныеЗаписи.Ссылка, ?(Группа.Количество() > 0, СокрЛП(Группа[0].Счет7), "")) Тогда
						ЗаписатьВЛог(ВыборкаДетальныеЗаписи.Ссылка, Лог, Истина, "ошибка формирования потока данных для выгрузки в 77. См. журнал регистрации");
						МассивОрганизацийСОшибками.Добавить(ВыборкаДетальныеЗаписи.Ссылка);
						Прогон = Прогон + 1;
						Продолжить;
					КонецЕсли;
			...
			ЗаписатьВЛог(ВыборкаДетальныеЗаписи.Ссылка, Лог, Ложь);
		КонецЦикла;
		
		/////////////////////////////////////////////////////////
		// вывод итогов
		
		ОбластьРазделительСтрок = Макет.ПолучитьОбласть("РазделительСтрок");
		ПараметрыОтчета.Итоги.ОстаткиОборотыОбщ.ЗаполнитьЗначения(Формат(ПараметрыОтчета.НачалоПериода, "ДФ=dd.MM.yyyy"), "ДатаНач");
		ПараметрыОтчета.Итоги.ОстаткиОборотыОбщ.ЗаполнитьЗначения(Формат(ПараметрыОтчета.КонецПериода, "ДФ=dd.MM.yyyy"), "ДатаКон");
		ПараметрыОтчета.Итоги.ОстаткиОборотыОбщ.Свернуть("ДатаНач,ДатаКон", "СуммаНачало,СуммаКонец,СуммаПриход,СуммаРасход");
		Т = Новый ТабличныйДокумент;
		Область = Макет.ПолучитьОбласть("ОстаткиОборотыОбщ|Отч1");
		Если ПараметрыОтчета.Итоги.ОстаткиОборотыОбщ.Количество() Тогда
			Область.Параметры.Заполнить(ПараметрыОтчета.Итоги.ОстаткиОборотыОбщ[0]);
		КонецЕсли;
		Т.Вывести(Область);
		Т.Вывести(ОбластьРазделительСтрок);
		
		//Если ПараметрыОтчета.Итоги.ОборотыОфис.Количество() Тогда
			ПараметрыОтчета.Итоги.ОборотыОфис.Свернуть("Фирма", "СуммаПриход,СуммаРасход");
			Область = Макет.ПолучитьОбласть("ОборотыОфис|ОтчОфис");
			Т.Вывести(Область); 
			Область = Макет.ПолучитьОбласть("ОборотыОфисСтрока|ОтчОфис");
			Для Каждого Стр Из ПараметрыОтчета.Итоги.ОборотыОфис Цикл
				Область.Параметры.Заполнить(Стр);
				Т.Вывести(Область);
			КонецЦикла;
			
			Область = Макет.ПолучитьОбласть("ОборотыОфисИтог|ОтчОфис");
			Область.Параметры.СуммаПриход = ПараметрыОтчета.Итоги.ОборотыОфис.Итог("СуммаПриход");
			Область.Параметры.СуммаРасход = ПараметрыОтчета.Итоги.ОборотыОфис.Итог("СуммаРасход");
			Т.Вывести(Область);
			Т.Вывести(ОбластьРазделительСтрок);
		//КонецЕсли;
		
		//Если ПараметрыОтчета.Итоги.ОборотыМальч.Количество() Тогда
			ПараметрыОтчета.Итоги.ОборотыМальч.Свернуть("Фирма", "СуммаПриход,СуммаРасход");
			Область = Макет.ПолучитьОбласть("ОборотыМальч|ОтчОфис");
			Т.Вывести(Область); 
			Область = Макет.ПолучитьОбласть("ОборотыМальчСтрока|ОтчОфис");
			Для Каждого Стр Из ПараметрыОтчета.Итоги.ОборотыМальч Цикл
				Область.Параметры.Заполнить(Стр);
				Т.Вывести(Область);
			КонецЦикла;
			
			Область = Макет.ПолучитьОбласть("ОборотыМальчИтог|ОтчОфис");
			Область.Параметры.СуммаПриход = ПараметрыОтчета.Итоги.ОборотыМальч.Итог("СуммаПриход");
			Область.Параметры.СуммаРасход = ПараметрыОтчета.Итоги.ОборотыМальч.Итог("СуммаРасход");
			Т.Вывести(Область);
			Т.Вывести(ОбластьРазделительСтрок);
		//КонецЕсли;
		
		//Если ПараметрыОтчета.Итоги.ОборотыМатериалы.Количество() Тогда
			ПараметрыОтчета.Итоги.ОборотыМатериалы.Свернуть("Фирма", "СуммаПриход,СуммаРасход");
			Область = Макет.ПолучитьОбласть("ОборотыМатериалы|ОтчОфис");
			Т.Вывести(Область); 
			Область = Макет.ПолучитьОбласть("ОборотыМатериалыСтрока|ОтчОфис");
			Для Каждого Стр Из ПараметрыОтчета.Итоги.ОборотыМатериалы Цикл
				Область.Параметры.Заполнить(Стр);
				Т.Вывести(Область);
			КонецЦикла;
			
			Область = Макет.ПолучитьОбласть("ОборотыМатериалыИтог|ОтчОфис");
			Область.Параметры.СуммаПриход = ПараметрыОтчета.Итоги.ОборотыМатериалы.Итог("СуммаПриход");
			Область.Параметры.СуммаРасход = ПараметрыОтчета.Итоги.ОборотыМатериалы.Итог("СуммаРасход");
			Т.Вывести(Область);
			Т.Вывести(ОбластьРазделительСтрок);
		//КонецЕсли;
		
		// Товары
		ТабТовар = ПараметрыОтчета.Итоги.ОстаткиОбороты.Скопировать(, "Фирма, РасходТовар");
		ТабТовар.Свернуть("Фирма", "РасходТовар");
		ТекКолонка = ТабТовар.Колонки.Найти("РасходТовар");
		ТекКолонка.Имя = "СуммаРасход";
		Область = Макет.ПолучитьОбласть("ОборотыТовары|ОтчОфис");
		Т.Вывести(Область); 
		Область = Макет.ПолучитьОбласть("ОборотыМатериалыСтрока|ОтчОфис");
		Для Каждого Стр Из ТабТовар Цикл
			Если Стр.СуммаРасход = 0 Тогда
				Продолжить;
			КонецЕсли;
			Область.Параметры.Заполнить(Стр);
			Т.Вывести(Область);
		КонецЦикла;
		Область = Макет.ПолучитьОбласть("ОборотыМатериалыИтог|ОтчОфис");
		Область.Параметры.СуммаРасход = ТабТовар.Итог("СуммаРасход");
		Т.Вывести(Область);
		Т.Вывести(ОбластьРазделительСтрок);

		//
		
		ТабВНД = ПараметрыОтчета.Итоги.ОстаткиОбороты.Скопировать(, "Фирма, ПриходВНД");
		ТабВНД.Свернуть("Фирма", "ПриходВНД");
		ТекКолонка = ТабВНД.Колонки.Найти("ПриходВНД");
		ТекКолонка.Имя = "СуммаПриход";
		//Если ТабВНД.Количество() Тогда
			
			Область = Макет.ПолучитьОбласть("ОборотыВНД|ОтчОфис");
			Т.Вывести(Область); 
			Область = Макет.ПолучитьОбласть("ОборотыМатериалыСтрока|ОтчОфис");
			Для Каждого Стр Из ТабВНД Цикл
			...
			Область = Макет.ПолучитьОбласть("ОборотыМатериалыИтог|ОтчОфис");
			Область.Параметры.СуммаПриход = ТабВНД.Итог("СуммаПриход");
			//Область.Параметры.СуммаРасход = ПараметрыОтчета.Итоги.ОборотыМатериалы.Итог("СуммаРасход");
			Т.Вывести(Область);
			Т.Вывести(ОбластьРазделительСтрок);
		...
		//Итоги.ОстаткиОбороты.Колонки.Добавить("ИтогоПриход");
		//Итоги.ОстаткиОбороты.Колонки.Добавить("ПроверкаПриход");
		//Итоги.ОстаткиОбороты.Колонки.Добавить("ИтогоРасход");
		//Итоги.ОстаткиОбороты.Колонки.Добавить("ПроверкаРасход");
		ПараметрыОтчета.Итоги.ОстаткиОбороты.Свернуть("Фирма", "СуммаНачало,СуммаКонец,СуммаПриход,СуммаРасход,ПриходКасса,ПриходРеализация,ПриходУчредит,ПриходУниверс,ПриходОфис,ПриходМальч,ПриходВНД,Приход57,ПриходВозврат,ПриходСТорно,ПриходМатериалы,ПриходПрочие,РасходКасса,РасходНалоги,РасходЗП,РасходУслуги,РасходТовар,РасходМатериалы,РасходУниверс,РасходПринципалы,РасходОфис,РасходМальч,Расход57,РасходПрочие,ИтогоПриход,ИтогоРасход,ПроверкаПриход,ПроверкаРасход,РасходТройств,РасходВетСправка,Приход51,Расход51");
		Область = Макет.ПолучитьОбласть("ОстаткиОбороты|Отч2");
		ОбластьДоп = Макет.ПолучитьОбласть("ОстаткиОбороты|Детально");
		ТТ.Вывести(Область);
		Если ПараметрыОтчета.РасширенныеИтоги Тогда
			ТТ.Присоединить(ОбластьДоп);
		КонецЕсли;
		Область = Макет.ПолучитьОбласть("ОстаткиОборотыСтрока|Отч2");
		ОбластьДоп = Макет.ПолучитьОбласть("ОстаткиОборотыСтрока|Детально");
		нпп = 1; 
		ИтогоЗатраты = 0; ИтогоЗатМлы = 0;
		Для Каждого Стр Из ПараметрыОтчета.Итоги.ОстаткиОбороты Цикл
			Область.Параметры.Заполнить(Стр);
			...
			Если ПараметрыОтчета.РасширенныеИтоги Тогда
				...
				// 2023.12.27
				//(14:27) Агнесса: ветсправка?
				//(14:27) БОРИС: да
				//(14:27) Агнесса: входит в расходы
				//(14:27) Агнесса: но надо эту сумму снять с оплаты за товар
				//
				//(14:43) БОРИС: по ветсправке: 2 варианта.
				//1. я просто отнимаю сумму от оплаты за товар
				//2. Делаю суммы ветсправки с "-" тогда в итоговой колонке она вычтется из общей суммы (при этом вывести в табличку могу со знаком "+")
				//(14:44) Агнесса: лучше вычесть с оплаты за товар
				Стр.РасходТовар = Стр.РасходТовар - Стр.РасходВетСправка;
				//
				
				ОбластьДоп.Параметры.Заполнить(Стр);
				Для Каждого К Из ПараметрыОтчета.Итоги.ОстаткиОбороты.Колонки Цикл
					ИмяКолонки = К.Имя;
					Если СтрНачинаетсяС(ВРег(ИмяКолонки), "ПРИХОД") Тогда
						Стр.ИтогоПриход = Стр.ИтогоПриход + Стр[ИмяКолонки];
					ИначеЕсли СтрНачинаетсяС(ВРег(ИмяКолонки), "РАСХОД") Тогда
						Стр.ИтогоРасход = Стр.ИтогоРасход + Стр[ИмяКолонки];
					КонецЕсли;
				КонецЦикла;
				Стр.ПроверкаПриход = Стр.СуммаПриход - Стр.ИтогоПриход;
				Стр.ПроверкаРасход = Стр.СуммаРасход - Стр.ИтогоРасход;
				ОбластьДоп.Параметры.ПроверкаПриход = Стр.ПроверкаПриход;
				ОбластьДоп.Параметры.ПроверкаРасход = Стр.ПроверкаРасход;
				ОбластьДоп.Параметры.ИтогоПриход = Стр.ИтогоПриход;
				ОбластьДоп.Параметры.ИтогоРасход = Стр.ИтогоРасход;
				
				ОбластьДоп.Параметры.Затраты = Стр.РасходЗП + Стр.РасходНалоги + Стр.РасходУслуги;
				ИтогоЗатраты = ИтогоЗатраты + ОбластьДоп.Параметры.Затраты;
				ОбластьДоп.Параметры.ЗатратыМлы = ?(Не ЗначениеЗаполнено(ОбластьДоп.Параметры.Затраты), 0, ОбластьДоп.Параметры.Затраты) + Стр.РасходМатериалы + Стр.РасходВетСправка;
				ИтогоЗатМлы = ИтогоЗатМлы + ОбластьДоп.Параметры.ЗатратыМлы;
	...
	Область = Макет.ПолучитьОбласть("ОстаткиОборотыИтог|Отч2");
	ОбластьДоп = Макет.ПолучитьОбласть("ОстаткиОборотыИтог|Детально");
	Область.Параметры.СуммаНачало = ПараметрыОтчета.Итоги.ОстаткиОбороты.Итог("СуммаНачало");
	Область.Параметры.СуммаКонец = ПараметрыОтчета.Итоги.ОстаткиОбороты.Итог("СуммаКонец");
	Область.Параметры.СуммаПриход = ПараметрыОтчета.Итоги.ОстаткиОбороты.Итог("СуммаПриход");
	Область.Параметры.СуммаРасход = ПараметрыОтчета.Итоги.ОстаткиОбороты.Итог("СуммаРасход");
	ТТ.Вывести(Область);
	Если ПараметрыОтчета.РасширенныеИтоги Тогда
		ПараметрыОтчета.Итоги.ОстаткиОбороты.Колонки.Добавить("И");
		ПараметрыОтчета.Итоги.ОстаткиОбороты.Свернуть("И", "СуммаНачало,СуммаКонец,СуммаПриход,СуммаРасход,ПриходКасса,ПриходРеализация,ПриходУчредит,ПриходУниверс,ПриходОфис,ПриходМальч,ПриходВНД,Приход57,ПриходВозврат,ПриходСТорно,ПриходМатериалы,ПриходПрочие,РасходКасса,РасходНалоги,РасходЗП,РасходУслуги,РасходТовар,РасходМатериалы,РасходУниверс,РасходПринципалы,РасходОфис,РасходМальч,Расход57,РасходПрочие,ИтогоПриход,ИтогоРасход,ПроверкаПриход,ПроверкаРасход,РасходТройств,РасходВетСправка,Приход51,Расход51");
		ОбластьДоп.Параметры.Заполнить(ПараметрыОтчета.Итоги.ОстаткиОбороты[0]);
		ОбластьДоп.Параметры.Затраты = ИтогоЗатраты;
		ОбластьДоп.Параметры.ЗатратыМлы = ИтогоЗатМлы;
		ТТ.Присоединить(ОбластьДоп);
	КонецЕсли;
		
	ТабличныйДокумент.ВставитьОбласть(Т.Область(1, 1, Т.ВысотаТаблицы, Т.ШиринаТаблицы), ТабличныйДокумент.Область(1, 35 + ?(ПараметрыОтчета.РасширенныеИтоги, 5, 0)), ТипСмещенияТабличногоДокумента.ПоГоризонтали);
	ТабличныйДокумент.ВставитьОбласть(ТТ.Область(1, 1, ТТ.ВысотаТаблицы, ТТ.ШиринаТаблицы), ТабличныйДокумент.Область(1, 40 + ?(ПараметрыОтчета.РасширенныеИтоги, 5, 0)), ТипСмещенияТабличногоДокумента.ПоГоризонтали);
	Для Счетчик = 36 + ?(ПараметрыОтчета.РасширенныеИтоги, 5, 0) По ТабличныйДокумент.ШиринаТаблицы Цикл
		ТабличныйДокумент.Область(1, Счетчик).ШиринаКолонки = 12;
		Если Счетчик = 45 ИЛИ Счетчик = 44 Тогда
			ТабличныйДокумент.Область(1, Счетчик).ШиринаКолонки = 6;
		КонецЕсли;
	КонецЦикла;
	
	//ПотокВыгрузки.Закрыть();
	
	ПарамФайлов = Новый Структура("ТаблДокумент,МассивОрганизацийСОшибками,Данные,Лог"
		, ТабличныйДокумент
		, МассивОрганизацийСОшибками
		, Неопределено//ПотокВПамяти.ЗакрытьИПолучитьДвоичныеДанные()
		, СформироватьТабДокЛог(Лог)
	);
...
Функция ПолучитьТаблицуСвоихФирм(Организация = Неопределено, Период) Экспорт
	...
	Запрос.Текст = "ВЫБРАТЬ
	               ...
	               |ГДЕ
	               |	Организации.ИНН <> &ИНН
	               |	И ЕСТЬNULL(АктуальностьОрганизацийСрезПоследних.Активна, ЛОЖЬ) = ИСТИНА
	               |	И Организации.ИНН <> """"";
	Если Не ЗначениеЗаполнено(Организация) Тогда
		Запрос.Текст = СтрЗаменить(Запрос.Текст, "Организации.ИНН <> &ИНН", "ИСТИНА");
	Иначе
...
Функция СформироватьТабДокЛог(Таблица) Экспорт

	ТабДок = Новый ТабличныйДокумент;
	Макет = Обработки.МММСервис.ПолучитьМакет("Лог");
	ОбластьУспешно = Макет.ПолучитьОбласть("Успешно");
	ОбластьОшибка = Макет.ПолучитьОбласть("Ошибка");

	Для Каждого Стр Из Таблица Цикл
		Если Стр.Ошибка Тогда
			ОбластьОшибка.Параметры.Заполнить(Стр);
			ТабДок.Вывести(ОбластьОшибка);
		Иначе
			ОбластьУспешно.Параметры.Заполнить(Стр);
			ТабДок.Вывести(ОбластьУспешно);
		КонецЕсли;
...
Процедура ЗаписатьВЛог(Организация, Лог = Неопределено, Ошибка = Истина, ОписаниеОшибки = "") Экспорт

	Если Лог = Неопределено Тогда
		Лог = Новый ТаблицаЗначений;
		Лог.Колонки.Добавить("Дата", Новый ОписаниеТипов("Дата"));
		Лог.Колонки.Добавить("Организация", Новый ОписаниеТипов("СправочникСсылка.Организации"));
		Лог.Колонки.Добавить("Ошибка", Новый ОписаниеТипов("Булево"));
		Лог.Колонки.Добавить("ОписаниеОшибки", Новый ОписаниеТипов("Строка"));
	КонецЕсли;

	НоваяСтрока = Лог.Найти(Организация, "Организация");
...
Функция СформироватьТабличноеПредставление(Прокси, ПараметрыОтчета, Организация, ТабличныйДокумент, Макет, Группа, ДанныеВыборки, НомерПП) Экспорт
	...
	ОбластьМакета = Макет.ПолучитьОбласть("Шапка|Основной");
	...
	ТекВысотаМакета = ТабличныйДокумент.ВысотаТаблицы;
	
	/////////////////////////////////////////////////////////
	// Формирование данных
	ИтСуммаДоп = 0;

	Курс = ПолучитьКурс(Прокси, ПараметрыОтчета.КонецПериода, Организация);

	ТаблицаЗП = Зарплата(
		Прокси, ПараметрыОтчета, Организация, ТабличныйДокумент, Макет, Курс);
	ТаблицаИЛ = ИсполнительныеЛисты(
		Прокси, ПараметрыОтчета, Организация, ТабличныйДокумент, Макет, Курс);
	ТаблицаНалогов = Налоги(
		Прокси, ПараметрыОтчета, Организация, ТабличныйДокумент, Макет, Курс);
	ИтогоСуммаЗПИЛНалоги = ТаблицаЗП.Итог("СуммаНалога") + ТаблицаИЛ.Итог("СуммаНалога") + ТаблицаНалогов.Итог("СуммаНалога");

	ТаблицаМатериалов = Материалы(
		Прокси, ПараметрыОтчета, Организация, ТабличныйДокумент, Макет, Группа, Курс);
	ТаблицаУслуг = Услуги(
		Прокси, ПараметрыОтчета, Организация, ТабличныйДокумент, Макет, Курс, ИтогоСуммаЗПИЛНалоги);
	ТаблицаКонтрагентыДопРеквизиты = КонтрагентыДополнительныеРеквизиты(
		Прокси, ПараметрыОтчета, Организация, ТабличныйДокумент, Макет, ИтСуммаДоп, Курс);
	...
	ОбластьМакетаИтого.Параметры.ИтогоУслуги = ТаблицаУслуг.Итог("СуммаУслуг") + ТаблицаЗаймы.Итог("СуммаУслуг");
	ОбластьМакетаИтого.Параметры.ИтогоНалоги = ТаблицаНалогов.Итог("СуммаНалога") + ?(ЗатратыСерверПереопределяемый.ЭтоФирмыЗП(Организация), ТаблицаИЛ.Итог("СуммаНалога") + ТаблицаЗП.Итог("СуммаНалога"), 0);
	...
	ОбластьМакетаИтого.Параметры.ИтСуммаИтого = ИтогоСуммаЗПИЛНалоги + ТаблицаУслуг.Итог("СуммаУслуг") + ТаблицаМатериалов.Итог("СуммаОплатМатериалов");
	
	ТабличныйДокумент.Вывести(ОбластьМакетаИтого);
	
	ВетСправка(
		Прокси, ТабличныйДокумент, Макет, ПараметрыОтчета, Организация, Курс);
		
	// оплата за товар
	ТаблицаНеВошедших = НеВошедшиеКонтрагентыПоУслугам(
			Прокси, ПараметрыОтчета, Организация, ТабличныйДокумент, Макет, Курс);
	ТекИтоги = ПараметрыОтчета.Итоги.ОстаткиОбороты.Скопировать(Новый Структура("Фирма", СокрЛП(Организация)));
	Если ТекИтоги.Итог("РасходТовар") <> 0 Тогда
		Область = Макет.ПолучитьОбласть("Товар");
		Область.Параметры.РасходТовар = ТекИтоги.Итог("РасходТовар");
		ТабличныйДокумент.Вывести(Область);
	КонецЕсли;
	//
	
	ОбластьМакетаЗатраты = Макет.ПолучитьОбласть("Всего");
	ОбластьМакетаЗатраты.Параметры.ИтСуммаВсего =
		ИтогоСуммаЗПИЛНалоги +
		ТаблицаУслуг.Итог("СуммаУслуг") +
		ТаблицаМатериалов.Итог("СуммаПоступленийМатериалов");
	ТабличныйДокумент.Вывести(ОбластьМакетаЗатраты);
	
	ОбластьМакетаВсего = Макет.ПолучитьОбласть("ВсегоПоВсем");
	ИтСуммаВсегоПоВсем = ИтогоСуммаЗПИЛНалоги +
		ТаблицаЗаймы.Итог("СуммаУслуг") +
		ИтСуммаДоп + //ТаблицаКонтрагентыДопРеквизиты.Итог("СуммаУслуг") + 
		ТаблицаУслуг.Итог("СуммаУслуг") +
		ТаблицаМатериалов.Итог("СуммаОплатМатериалов") + 
		ТекИтоги.Итог("РасходТовар");
	ОбластьМакетаВсего.Параметры.ИтСуммаВсегоПоВсем = ИтСуммаВсегоПоВсем;
	ТабличныйДокумент.Вывести(ОбластьМакетаВсего);
	
	/////////////////////////////////////////////////////////
	ТабличныйДокумент.НачатьАвтоГруппировкуСтрок();
	
	СуммаПроверки = Проверка(
		Прокси, ТабличныйДокумент, Макет, ПараметрыОтчета, Организация, Курс);

		
	//отклонение
	ОбластьОтклонение = Макет.ПолучитьОбласть("Отклонение");
	ОбластьОтклонение.Параметры.отклонение = СуммаПроверки - ИтСуммаВсегоПоВсем;
	ТабличныйДокумент.Вывести(ОбластьОтклонение);
	...
	ТабличныйДокумент.НачатьАвтоГруппировкуСтрок();
	ВывестиНеВошедшиеКонтрагентыПоУслугам(
		Прокси, ПараметрыОтчета, Организация, ТабличныйДокумент, Макет, Курс, ТаблицаНеВошедших);
	ТабличныйДокумент.ЗакончитьАвтоГруппировкуСтрок(); 
	...
	Если ПараметрыОтчета.РасширенныеИтоги Тогда
		...
		Т = Новый ТабличныйДокумент;
		Область = Макет.ПолучитьОбласть("Шапка|ИИтог");
		
		Область.Параметры.ИЗатраты = ОбластьМакетаЗатраты.Параметры.ИтСуммаВсего;
		Область.Параметры.ИОПРиход = ТекИтоги.Итог("ПриходОфис");
		Область.Параметры.ИОРасход = ТекИтоги.Итог("РасходОфис");
		Область.Параметры.ИУниверс = ТекИтоги.Итог("РасходУниверс");
		
		Т.Вывести(Область);
		
		СтрокаКудаВставить = ТекВысотаМакета-3;
		ТабличныйДокумент.ВставитьОбласть(Т.Область(1, 1, Т.ВысотаТаблицы, Т.ШиринаТаблицы), ТабличныйДокумент.Область(СтрокаКудаВставить, 35), ТипСмещенияТабличногоДокумента.ПоГоризонтали);
		Для Счетчик = 35 По Т.ШиринаТаблицы + 35 Цикл
			ТабличныйДокумент.Область(СтрокаКудаВставить, Счетчик).ШиринаКолонки = 12;
		КонецЦикла;
	КонецЕсли;
...
Функция СформироватьПоток(Прокси, ПараметрыОтчета, Организация, Группа) Экспорт
	...
	Запрос.Параметры.Вставить("БазаУТП", Организация.БазаУТП);
	СвоиФирмы = ПолучитьТаблицуСвоихФирм(Организация, ПараметрыОтчета.КонецПериода);
	Запрос.Параметры.Вставить("СвоиФирмы", СвоиФирмы.ВыгрузитьКолонку("ИНН"));
	Запрос.ТекстЗапроса = ТекстЗапроса(Организация.БазаУТП);
	
	ФормироватьКассу = ЗатратыСерверПереопределяемый.ЭтоКассоваяФирма(Организация, ПараметрыОтчета.КонецПериода);
	Запрос.ТекстЗапроса = СтрЗаменить(Запрос.ТекстЗапроса, "#ФормироватьКассу",?(ФормироватьКассу, "ИСТИНА", "ЛОЖЬ"));

	Запрос.ТекстЗапроса = СтрЗаменить(Запрос.ТекстЗапроса,
		"ЗНАЧЕНИЕ(ПланСчетов.Хозрасчетный.РасчетныеСчета)",
		СтрШаблон("ЗНАЧЕНИЕ(ПланСчетов.Хозрасчетный.%1)", 
			РегистрыСведений.Меппинг.ПолучитьЗамену(Организация, "РасчетныеСчета")
		)
	);
	...
	Ответ.Результат = ПересчитатьТаблицуПоКурсу(Ответ.Результат, "СуммаОборот,СуммаОборотДт,СуммаОборотКт", Курс);
	...
	ПоступлениеТоваров(
		Прокси, ПараметрыОтчета, Организация, Группа, Курс);
	...
	Для Каждого ЗаписьРегистра Из Набор Цикл
		Если (Запись.СуммаОперации < 0 И ЗаписьРегистра.СуммаОперации < 0) 
			...
			Если Статус = ЗатратыКлиентСервер.СтатусОтправки_Ошибка() Тогда
				СтрокаОшибка = СтрШаблон("%1: %2", ТекущаяДатаСеанса(), ОписаниеОшибки);
				ЗаписьРегистра.ОшибкаВыгрузки =
					?(ПустаяСтрока(ЗаписьРегистра.ОшибкаВыгрузки), СтрокаОшибка, ЗаписьРегистра.ОшибкаВыгрузки + Символы.ПС + СтрокаОшибка);
			Иначе
				СтрокаОшибка = СтрШаблон("%1: %2", ТекущаяДатаСеанса(), ?(ДопПараметры = Неопределено, "", ДопПараметры.ОписаниеОшибки));
				ЗаписьРегистра.ОшибкаВыгрузки = ?(ДопПараметры = Неопределено, "",
					?(ПустаяСтрока(ЗаписьРегистра.ОшибкаВыгрузки), СтрокаОшибка, ЗаписьРегистра.ОшибкаВыгрузки + Символы.ПС + СтрокаОшибка)
				);
			КонецЕсли;	
			Если НЕ ПустаяСтрока(Комментарий) Тогда
				СтрокаОшибка = СтрШаблон("%1: %2", ТекущаяДатаСеанса(), Комментарий);

				ЗаписьРегистра.Комментарий = 
						?(ПустаяСтрока(ЗаписьРегистра.Комментарий), СтрокаОшибка, ЗаписьРегистра.Комментарий + Символы.ПС + СтрокаОшибка);
			КонецЕсли;
...
Функция ПересчитатьТаблицуПоКурсу(Таблица, Поле = "Сумма", Курс = 1)
	
	Если Не ТипЗнч(Таблица) = Тип("ТаблицаЗначений") Тогда
		ЗаписьЖурналаРегистрации("Отчет затраты", УровеньЖурналаРегистрации.Ошибка, ,, "ПересчитатьТаблицуПоКурсу, в качестве таблицы передано "+ТипЗнч(Таблица));
		Возврат Таблица;
	КонецЕсли;
...
Функция ПолучитьКурс(Прокси, Период, Организация) Экспорт

	Курс = 1;
	Если Организация.БазаУТП Тогда
		Запрос = мммСервер.ЗапросПрокси();
		Запрос.Параметры.Вставить("НаДату", Период);
		Запрос.ТекстЗапроса = "
			|ВЫБРАТЬ
			|	КурсыВалютСрезПоследних.Курс / КурсыВалютСрезПоследних.Кратность КАК Курс
			|ИЗ
			|	РегистрСведений.КурсыВалют.СрезПоследних(КОНЕЦПЕРИОДА(&НаДату, ДЕНЬ), Валюта.Код = ""643"") КАК КурсыВалютСрезПоследних";
		Ответ = мммСервер.ДеСериализовать(
			Прокси.RunQuery(мммСервер.Сериализовать(Запрос))
		);
		Если НЕ Ответ.Ошибка Тогда
			Если Ответ.Результат.Количество() > 0 Тогда
				Курс = Ответ.Результат[0].Курс;
			КонецЕсли;
		КонецЕсли;
	КонецЕсли;
...
Функция ПолучитьГруппуПоИНН(Период, ИНН) Экспорт

	рсСвязь = РегистрыСведений.СвязьОрганизаций8ИСчетов7.ПолучитьПоследнее(Период, 
				Новый Структура("Организация8", Справочники.Организации.НайтиПоРеквизиту("ИНН", ИНН))
	);

	Возврат СокрЛП(рсСвязь.Счет7.Наименование);	
...
Функция ВыпискаПроверитьСтроку(Данные, ДокВыписка, ДопПараметр, ДелатьЗеркальнуюОперацию = Ложь) Экспорт
	...
	ОПЛАТАЗА = Данные.ВидОперации.ОплатаЗаКонтрагента;

	ГруппаКонтраегнта = "";
	Если СвояФирма Тогда
		ГруппаКонтраегнта = ПолучитьГруппуПоИНН(Данные.Период, КонтрагентИНН);
	КонецЕсли;
	...
	ИначеЕсли СтрНайти(Содержание, "Оплата поставщикам") > 0 
		...
		И Сумма < 0
		И (ДокВыписка.ВидДвижения = "Оплата поставщику" ИЛИ ДокВыписка.ВидДвижения = "Оплата поставщику материалы")
		И ДокВыписка.КоррСчет = "60.1"
	...
	ИначеЕсли (СтрНайти(Содержание, "Оплата поставщикам") > 0 ИЛИ СтрНайти(Содержание, "Прочие расходы") > 0 ИЛИ СтрНайти(Содержание, "СБП") > 0 ИЛИ ПустаяСтрока(Содержание)) 
		...
		И Сумма < 0
		И (ДокВыписка.ВидДвижения = "Оплата поставщику" ИЛИ ДокВыписка.ВидДвижения = "Прочие выплаты"  ИЛИ ДокВыписка.ВидДвижения = "Затраты") 
		И ДокВыписка.КоррСчет = "60.1"
	...
	ИначеЕсли СтрНайти(Содержание, "Оплата поставщику по тройственному") > 0 
		И КорСчет = "60"
		И ПустаяСтрока(ТипКлиента)
		И ПОСТАВЩИКИ
		И НЕ СвояФирма И НЕ РЕКЛАМА И НЕ ОПТ И НЕ МАТЕРИАЛЫ И НЕ МАЛЬЧИКИ И НЕ ЗАТРАТЫ И НЕ АРЕНДА 
		И Сумма < 0
		И (ДокВыписка.ВидДвижения = "Оплата поставщику по тройственному")
		И ДокВыписка.КоррСчет = "60.1"
		И ДокВыписка.Субконто1 = "Поставщики товара " + Группа 
		И Истина Тогда
		Возврат Истина;
	...
	ИначеЕсли (СтрНайти(Содержание, "Оплата поставщикам") > 0 ИЛИ СтрНайти(Содержание, "Прочие расходы") > 0)
		...
		И Сумма < 0
		И (ДокВыписка.ВидДвижения = "Оплата поставщику" ИЛИ ДокВыписка.ВидДвижения = "Прочие выплаты" ИЛИ ДокВыписка.ВидДвижения = "Офис")
		И ДокВыписка.КоррСчет = "60.1"
		И ДокВыписка.Субконто1 = "ОН" И ДокВыписка.Субконто2 = "оф"
		И Истина Тогда
		Возврат Истина;

	ИначеЕсли (НЕ Содержание = "Оплата по тройственному договору")//(СтрНайти(Содержание, "Оплата поставщикам") > 0 ИЛИ СтрНайти(Содержание, "Возврат от поставщиков") > 0) 
		И КорСчет = "60"
	...
	ИначеЕсли Содержание = "Оплата по тройственному договору"
		И КорСчет = "60"
		И (ТипКлиента = "Фирмы универсама" ИЛИ ПустаяСтрока(ТипКлиента))
		И СвояФирма
	//	И НЕ ПОСТАВЩИКИ И НЕ РЕКЛАМА И НЕ ОПТ И НЕ МАТЕРИАЛЫ И НЕ МАЛЬЧИКИ И НЕ ЗАТРАТЫ И НЕ АРЕНДА 
		...
		И ДокВыписка.КоррСчет = "51"
		И СтрНайти(ДокВыписка.Субконто1, ГруппаКонтраегнта) > 0
		И ?(Сумма > 0, ДокВыписка.СуммаРасход = "0", ДокВыписка.СуммаПриход = "0") Тогда
		Возврат Истина;
	...
	ИначеЕсли СтрНайти(Содержание, "Оплата поставщик") > 0 
		И КорСчет = "60"
		И ПустаяСтрока(ТипКлиента)
		И МАЛЬЧИКИ
		И НЕ ПОСТАВЩИКИ	И НЕ СвояФирма И НЕ ОПТ И НЕ МАТЕРИАЛЫ И НЕ АРЕНДА И НЕ ЗАТРАТЫ И НЕ РЕКЛАМА
		И Сумма < 0
		И (ДокВыписка.ВидДвижения = "Оплата поставщику" ИЛИ ДокВыписка.ВидДвижения = "Партнеры")
		И ДокВыписка.КоррСчет = "60.1"
	...
	ИначеЕсли (СтрНайти(Содержание, "Расходы на услуги банков") > 0 ИЛИ СтрНайти(Содержание, "Прочие расходы") > 0)
		И КорСчет = "91"
		И ПустаяСтрока(ТипКлиента)
		И НЕ ПОСТАВЩИКИ	И НЕ СвояФирма И НЕ РЕКЛАМА И НЕ ОПТ И НЕ МАТЕРИАЛЫ И НЕ МАЛЬЧИКИ И НЕ ЗАТРАТЫ И НЕ АРЕНДА 
	//	И Сумма < 0
		И (ДокВыписка.ВидДвижения = "Затраты" ИЛИ ДокВыписка.ВидДвижения =  ?(Сумма < 0, "Прочие выплаты", "Прочие поступления") ИЛИ ДокВыписка.ВидДвижения =  ?(Сумма < 0, "Оплата поставщику", "Прочие поступления"))
		И ДокВыписка.КоррСчет = "60.1"
		И ДокВыписка.Субконто1 = "ЕМ" И СтрНайти(СокрЛП(ДокВыписка.Субконто2), "затр") > 0
		И Истина Тогда
		Возврат Истина;
	...
	ИначеЕсли //СтрНайти(Содержание, "Оплата поставщикам") > 0 
		...
		И Сумма > 0
		И (ДокВыписка.ВидДвижения = "Прочие поступления" ИЛИ ДокВыписка.ВидДвижения = "Поступления от покупателей" ИЛИ ДокВыписка.ВидДвижения = "Офис")
	...
	ИначеЕсли СтрНайти(Содержание, "Оплата от покупателей") > 0 
		...
		И НЕ ПОСТАВЩИКИ	И НЕ СвояФирма И НЕ ОПТ И НЕ МАТЕРИАЛЫ И НЕ АРЕНДА И НЕ ЗАТРАТЫ И НЕ РЕКЛАМА
		И Сумма > 0
		И (ДокВыписка.ВидДвижения = "Поступления от покупателей" ИЛИ ДокВыписка.ВидДвижения = "Партнеры")
		И ДокВыписка.КоррСчет = "62.1"
		И ДокВыписка.Субконто1 = "Мальч Н" 
		И Истина Тогда
		Возврат Истина;
	...
	ИначеЕсли (СтрНайти(Врег(Содержание), "СБП") > 0 ИЛИ СтрНайти(Врег(Содержание), "ЭКВАЙРИНГ") > 0) 
		И КорСчет = "62"
		И ПустаяСтрока(ТипКлиента)
		И ЗАТРАТЫ
	...
	ИначеЕсли ИСТИНА
		И КорСчет = "62"
		И ПустаяСтрока(ТипКлиента)
		И (ПОСТАВЩИКИ ИЛИ ЗАТРАТЫ)
		И НЕ СвояФирма И НЕ МАЛЬЧИКИ И НЕ МАТЕРИАЛЫ И НЕ АРЕНДА И НЕ ОПТ
		И Сумма > 0
		И (ДокВыписка.ВидДвижения = "ВНД")
		И ДокВыписка.КоррСчет = "62.5"
		//И ДокВыписка.Субконто1 = "ВНД"
		И СтрНайти(ВРег(ДокВыписка.Субконто1), Врег("Поставщики товара")) > 0
		И СтрНайти(ВРег(ДокВыписка.Субконто2), Врег("премия")) > 0 Тогда
		Возврат Истина;
	...
	ИначеЕсли ИСТИНА
		...
		//И ДокВыписка.Субконто1 = "ВНД"
		И СтрНайти(ВРег(ДокВыписка.Субконто1), Врег("Поставщики товара")) > 0
		И СтрНайти(ВРег(ДокВыписка.Субконто2), Врег("реклама")) > 0 Тогда
		Возврат Истина;
		
	ИначеЕсли ИСТИНА 
		И КорСчет = "62"
		И (ПустаяСтрока(ТипКлиента) ИЛИ ТипКлиента = "Фирмы универсама")
		И СвояФирма
	...
	//	И ДокВыписка.ВидДвижения = "Прочие поступления"
		И ДокВыписка.КоррСчет = "62.1"
		И ДокВыписка.Субконто1 = "ОН" 
		И ДокВыписка.Субконто2 = "оф" Тогда
		Возврат Истина;		
	...
	ИначеЕсли ИСТИНА//(СтрНайти(Содержание, "Прочие налоги и сборы") > 0 ИЛИ СтрНайти(Содержание, "Налог на прибыль") > 0 ИЛИ СтрНайти(Содержание, "Штрафы госорганов") > 0 ИЛИ СтрНайти(Содержание, "Прочие расходы") > 0) 
		...
		И (ДокВыписка.ВидДвижения = "Оплата поставщику" ИЛИ ДокВыписка.ВидДвижения = "Прочие выплаты" ИЛИ ДокВыписка.ВидДвижения = "Затраты")
		И ДокВыписка.КоррСчет = "60.1"
		И ДокВыписка.Субконто1 = "ЕМ" И (СтрНайти(СокрЛП(ДокВыписка.Субконто2), "ЗП/налоги") > 0  ИЛИ ДокВыписка.Субконто2 = "налоги")
		И Истина Тогда
		Возврат Истина;
	...
	ИначеЕсли //(СтрНайти(Содержание, "Розничная выручка") > 0 ИЛИ СтрНайти(Содержание, "Сдача наличных в банк") > 0 ИЛИ СтрНайти(Содержание, "Внутреннее перемещение денежных средств") > 0)
		...
		И ДокВыписка.КоррСчет = ЗатратыСерверПереопределяемый.Счет50(Данные.Организация)
		И Истина Тогда
		
		//Если ЗатратыСерверПереопределяемый.ЭтоБоткоЗевс(Данные.Организация) ИЛИ ЗатратыСерверПереопределяемый.ЭтоЖасмин(Данные.Организация) Тогда
		Если ЗатратыСерверПовтИсп.СчетКассаПоУмолчанию() = ЗатратыСерверПереопределяемый.Стар_Счет50(Данные.Организация) Тогда
		Иначе
	...
	ИначеЕсли
		...
		И НЕ СвояФирма И НЕ МАЛЬЧИКИ И НЕ МАТЕРИАЛЫ И НЕ АРЕНДА И НЕ ОПТ И НЕ РЕКЛАМА И НЕ ПОСТАВЩИКИ  И НЕ ЗАТРАТЫ
		И Сумма < 0
		И ДокВыписка.ВидДвижения = "Получение наличных из банка"
		И ДокВыписка.КоррСчет = ЗатратыСерверПереопределяемый.Счет50(Данные.Организация)
		И Истина Тогда
	...
	//	И НЕ МАЛЬЧИКИ И НЕ МАТЕРИАЛЫ И НЕ ОПТ И НЕ РЕКЛАМА И НЕ ПОСТАВЩИКИ  И НЕ ЗАТРАТЫ  		
		И (ДокВыписка.ВидДвижения = ?(Сумма > 0 , "Прочие поступления", "Прочие выплаты") 
			...
			ИЛИ ДокВыписка.ВидДвижения = "Перемещение денег между фирмами универсама")
		И (ДокВыписка.КоррСчет = "51" ИЛИ ДокВыписка.КоррСчет = ЗатратыСерверПереопределяемый.Счет50(КонтрагентИНН))
		...
		Если Результат.Пустой() Тогда
			// с 50 счета
			Если ДокВыписка.КоррСчет = ЗатратыСерверПереопределяемый.Счет50(КонтрагентИНН) Тогда
				ДелатьЗеркальнуюОперацию = Истина;
				Возврат Истина;
			КонецЕсли;	
		КонецЕсли;
		...
		Если Выборка.Следующий() Тогда
			Если ДокВыписка.КоррСчет = "51" И ДокВыписка.Субконто1 = ГруппаКонтраегнта Тогда
				...
				Если ?(РезСумма<0, -1*РезСумма, РезСумма) <> ?(Сумма<0, -1*Сумма, Сумма) Тогда
					...
					// в случае если сумма не совпадает - запишем ее все равно
					// изменено, возможно надо будет вернуть назад
					Возврат Истина;
	...
	ИначеЕсли ИСТИНА //(СтрНайти(Содержание, "Торговая выручка") > 0 ИЛИ СтрНайти(Содержание, "Прочие поступления") > 0)
		...
		И (ДокВыписка.ВидДвижения = ?(Сумма > 0 , "Прочие поступления", "Прочие выплаты") 
			...
			ИЛИ ДокВыписка.ВидДвижения = "Депонент")
		И ДокВыписка.КоррСчет = "60.1" 
		И ДокВыписка.Субконто1 = "ЕМ" 
		И (СтрНайти(ДокВыписка.Субконто2, "перс") > 0 
			ИЛИ СтрНайти(ДокВыписка.Субконто2, "зарплата") > 0 
			ИЛИ СтрНайти(ДокВыписка.Субконто2, "ЗП/налоги") > 0)
		И Истина Тогда
		Возврат Истина;			
	...
	ИначеЕсли ИСТИНА //(СтрНайти(Содержание, "Торговая выручка") > 0 ИЛИ СтрНайти(Содержание, "Прочие поступления") > 0)
		И (КорСчет = "75" ИЛИ КорСчет = "67" ИЛИ КорСчет = "66")
		//И ПустаяСтрока(ТипКлиента)
		//И НЕ СвояФирма
	//	И НЕ МАЛЬЧИКИ И НЕ МАТЕРИАЛЫ И НЕ АРЕНДА И НЕ ОПТ И НЕ РЕКЛАМА И НЕ ПОСТАВЩИКИ  И НЕ ЗАТРАТЫ
		И (ДокВыписка.ВидДвижения = ?(Сумма > 0 , "Прочие поступления", "Прочие выплаты") 
	...
	ИначеЕсли ИСТИНА //(СтрНайти(Содержание, "Торговая выручка") > 0 ИЛИ СтрНайти(Содержание, "Прочие поступления") > 0)
		...
		//И НЕ СвояФирма
		//И НЕ МАЛЬЧИКИ И НЕ МАТЕРИАЛЫ И НЕ АРЕНДА И НЕ ОПТ И НЕ РЕКЛАМА И НЕ ПОСТАВЩИКИ  И НЕ ЗАТРАТЫ
		И ?(Сумма > 0, ДокВыписка.СуммаРасход = "0", ДокВыписка.СуммаПриход = "0")
		И (ДокВыписка.ВидДвижения = ?(Сумма > 0 , "Прочие поступления", "Прочие выплаты") ИЛИ ДокВыписка.ВидДвижения = "Деньги в пути")
	...
	////////////////////////////////////////////////
	// 58
	ИначеЕсли СтрНайти(Содержание, "Поступления от погашения займов") > 0 
		И КорСчет = "58"
		//И ПустаяСтрока(ТипКлиента)
		И МАЛЬЧИКИ
		И НЕ ПОСТАВЩИКИ	И НЕ СвояФирма И НЕ ОПТ И НЕ МАТЕРИАЛЫ И НЕ АРЕНДА И НЕ ЗАТРАТЫ И НЕ РЕКЛАМА
		И Сумма > 0
		И ДокВыписка.ВидДвижения = "Партнеры"
		И ДокВыписка.КоррСчет = "62.1"
		И ДокВыписка.Субконто1 = "Мальч Н"
		И Истина Тогда
		Возврат Истина;
...
Функция ОперацияПроверитьСтроку(Данные, ТекСтрока, СуммаПоМодулю = Ложь, ДопПараметр = "") Экспорт
	...
	Если СвояФирма Тогда
		...
		ФирмаУниверсама = ЗатратыСерверПереопределяемый.ЭтоФирмыУниверсама(КонтрагентИНН) ИЛИ (ТипКлиента = "Фирмы универсама");
	КонецЕсли;
	...
	Если СвояФирма И НЕ ЗатратыСерверПереопределяемый.ЭтоКассоваяФирма(Данные.Организация) Тогда
	...
	Если СтрНайти(Содержание, "Внутреннее перемещение денежных средств") > 0 
		...
		И Сумма < 0
		И ТекСтрока.СчДт = "51"	И ТекСтрока.СчКт = ЗатратыСерверПереопределяемый.Счет50(Данные.Организация)
	...
	//	И НЕ РЕКЛАМА И НЕ ОПТ И НЕ МАТЕРИАЛЫ И НЕ МАЛЬЧИКИ И НЕ ЗАТРАТЫ И НЕ АРЕНДА И НЕ ПОСТАВЩИКИ
		...
		И НЕ ЗатратыСерверПереопределяемый.ЭтоКассоваяФирма(КонтрагентИНН)
		И ТекСтрока.СчКт = ЗатратыСерверПереопределяемый.Счет50(Данные.Организация)
		И ТекСтрока.СчДт = "51"
	...
	ИначеЕсли СтрНайти(Содержание, "Розничная выручка") > 0 
		...
		И НЕ РЕКЛАМА И НЕ ОПТ И НЕ МАТЕРИАЛЫ И НЕ МАЛЬЧИКИ И НЕ ЗАТРАТЫ И НЕ АРЕНДА И НЕ ПОСТАВЩИКИ
		И Сумма < 0 	
		И ЗатратыСерверПереопределяемый.ЭтоКассоваяФирма(КонтрагентИНН)
		И ТекСтрока.СчКт = ЗатратыСерверПереопределяемый.Счет50(Данные.Организация)
	...
	//	И НЕ РЕКЛАМА И НЕ ОПТ И НЕ МАТЕРИАЛЫ И НЕ МАЛЬЧИКИ И НЕ ЗАТРАТЫ И НЕ АРЕНДА И НЕ ПОСТАВЩИКИ
		И Сумма > 0 	// поступление в кассу
		И ЗатратыСерверПереопределяемый.ЭтоКассоваяФирма(КонтрагентИНН)
		И ТекСтрока.СчДт = ЗатратыСерверПереопределяемый.Счет50(Данные.Организация)
	...
	//	И НЕ СвояФирма И НЕ РЕКЛАМА И НЕ ОПТ И НЕ МАТЕРИАЛЫ И НЕ МАЛЬЧИКИ И НЕ ЗАТРАТЫ И НЕ АРЕНДА И НЕ ПОСТАВЩИКИ
		И Сумма > 0
		И ТекСтрока.СчДт = ЗатратыСерверПереопределяемый.Счет50(Данные.Организация)	И ТекСтрока.СчКт = "90.1.1"
	...
	ИначеЕсли СтрНайти(Содержание, "Возврат покупателям") > 0
		...
		И НЕ СвояФирма И НЕ РЕКЛАМА И НЕ ОПТ И НЕ МАТЕРИАЛЫ И НЕ МАЛЬЧИКИ И НЕ ЗАТРАТЫ И НЕ АРЕНДА И НЕ ПОСТАВЩИКИ
		И Сумма < 0
		И ЗатратыСерверПереопределяемый.ЭтоБоткоЗевс(Данные.Организация)
		И ТекСтрока.СчДт = ЗатратыСерверПереопределяемый.Счет50(Данные.Организация)	И ТекСтрока.СчКт = "90.1.1"
		И СтрНайти(НРег(ТекСтрока.СодержаниеПроводки), "выручка") > 0 Тогда
	...
	//	И НЕ СвояФирма И НЕ РЕКЛАМА И НЕ ОПТ И НЕ МАТЕРИАЛЫ И НЕ МАЛЬЧИКИ И НЕ ЗАТРАТЫ И НЕ АРЕНДА И НЕ ПОСТАВЩИКИ
		И Сумма < 0
		И НЕ ЗатратыСерверПереопределяемый.ЭтоБоткоЗевс(Данные.Организация)
		И ТекСтрока.СчДт = ЗатратыСерверПереопределяемый.Счет50(Данные.Организация)	И ТекСтрока.СчКт = "90.1.1" 
	...
	//	И НЕ СвояФирма И НЕ РЕКЛАМА И НЕ ОПТ И НЕ МАТЕРИАЛЫ И НЕ МАЛЬЧИКИ И НЕ ЗАТРАТЫ И НЕ АРЕНДА И НЕ ПОСТАВЩИКИ
		И Сумма < 0
		И ЗатратыСерверПереопределяемый.ЭтоКассоваяФирма(Данные.Организация)
		И ТекСтрока.СчДт = "50.1" И ТекСтрока.СчКт = ЗатратыСерверПереопределяемый.Счет50(Данные.Организация)
	...
	//	И НЕ СвояФирма И НЕ РЕКЛАМА И НЕ ОПТ И НЕ МАТЕРИАЛЫ И НЕ МАЛЬЧИКИ И НЕ ЗАТРАТЫ И НЕ АРЕНДА И НЕ ПОСТАВЩИКИ
	//	И Сумма > 0
		И НЕ ЗатратыСерверПереопределяемый.ЭтоКассоваяФирма(Данные.Организация)
	...
	ИначеЕсли ИСТИНА // СтрНайти(Содержание, "Оплата поставщик") > 0 
		...
		И СвояФирма 
		И НЕ ЗатратыСерверПереопределяемый.ЭтоКассоваяФирма(Данные.Организация)
		И ТекСтрока.СчДт = ?(Сумма > 0, ЗатратыСерверПереопределяемый.Счет50(Данные.Организация), "51")	
		И ТекСтрока.СчКт = ?(Сумма > 0, "51", ЗатратыСерверПереопределяемый.Счет50(Данные.Организация))
	...
	ИначеЕсли ИСТИНА // СтрНайти(Содержание, "Оплата поставщик") > 0 
		...
		И ЗатратыСерверПереопределяемый.ЭтоКассоваяФирма(Данные.Организация)
		И ЗатратыСерверПереопределяемый.ЭтоКассоваяФирма(КонтрагентИНН)
		И ТекСтрока.СчДт = ?(Сумма > 0, ЗатратыСерверПереопределяемый.Счет50(Данные.Организация), ЗатратыСерверПереопределяемый.Счет50(КонтрагентИНН))	
		И ТекСтрока.СчКт = ?(Сумма > 0, ЗатратыСерверПереопределяемый.Счет50(КонтрагентИНН), ЗатратыСерверПереопределяемый.Счет50(Данные.Организация))
		И ИСТИНА  Тогда
		СуммаПоМодулю = Истина;
		Возврат Истина;		
	...
	//	И ПустаяСтрока(ТипКлиента)
		...
		И ТекСтрока.СчДт = ?(Сумма > 0, ЗатратыСерверПереопределяемый.Счет50(Данные.Организация), "60.1")	
		И ТекСтрока.СчКт = ?(Сумма > 0, "60.1", ЗатратыСерверПереопределяемый.Счет50(Данные.Организация))
	...
	ИначеЕсли ИСТИНА  
		...
		И (ТипКлиента = "Офис" ИЛИ АРЕНДА ИЛИ РЕКЛАМА) 
		И НЕ СвояФирма И НЕ ОПТ И НЕ МАТЕРИАЛЫ И НЕ МАЛЬЧИКИ И НЕ ПОСТАВЩИКИ И НЕ ЗАТРАТЫ
		И ТекСтрока.СчДт = ?(Сумма > 0, ЗатратыСерверПереопределяемый.Счет50(Данные.Организация), "62.1")	
		И ТекСтрока.СчКт = ?(Сумма > 0, "62.1", ЗатратыСерверПереопределяемый.Счет50(Данные.Организация))
		И ?(Сумма > 0, Истина, ТекСтрока.СубконтоДт1 = "ОН") 
		И ?(Сумма > 0, Истина, ТекСтрока.СубконтоДт2 = "оф") 
		И ?(Сумма > 0, ТекСтрока.СубконтоКт1 = "ОН", Истина) 
		И ?(Сумма > 0, ТекСтрока.СубконтоКт2 = "оф", Истина) Тогда
	...
	ИначеЕсли ИСТИНА 
		И КорСчет = "71"
		И ТекСтрока.СчДт = ?(Сумма > 0, ЗатратыСерверПереопределяемый.Счет50(Данные.Организация), "71.1")
		И ТекСтрока.СчКт = ?(Сумма > 0, "71.1", ЗатратыСерверПереопределяемый.Счет50(Данные.Организация)) Тогда
		СуммаПоМодулю = Истина;
		Возврат Истина;				
...
Функция ПолучитьЗаКогоОплата(Данные) Экспорт

	Если Не ЗначениеЗаполнено(Данные.ОплатаЗаКонтрагента) Тогда
		Возврат Неопределено;
	КонецЕсли;

	Возврат Новый Структура("Организация, ИНН", Данные.ОплатаЗаКонтрагента, Данные.ОплатаЗаКонтрагента.ИНН);

КонецФункции

Функция ВидОперацииВыпискаПеремещениеНа51(ОрганизацияИсточник, ОрганизацияПриемник) Экспорт

	ТекДокумент = ПредопределенноеЗначение("Перечисление.ВидыВыгружаемыхДокументов.Выписка");
	Ст = Новый Структура("СвояФирма,Организация,Счет,Контрагент,КонтрагентИНН,КорСчет,Аналитика",
		Истина,
		ОрганизацияИсточник,
		"51",
		ОрганизацияПриемник.Наименование,
		ОрганизацияПриемник.ИНН,
		"60",
		"Оплата по тройственному договору"
	);
	ТекВидОперации = НайтиВидОперации(Ст, ТекДокумент, ОрганизацияИсточник);

	Возврат ТекВидОперации;

КонецФункции

Функция ВидОперацииВыпискаОплатаПоТройственному(Организация, ИсходныйВидОперации) Экспорт

	ТекДокумент = ПредопределенноеЗначение("Перечисление.ВидыВыгружаемыхДокументов.Выписка");

	Ст = ЗатратыСерверПовтИсп.РеквизитыВидаОперацииВСТруктуру();
	ЗаполнитьЗначенияСвойств(Ст, ИсходныйВидОперации);
	Ст.Аналитика = "Оплата поставщику по тройственному";

	ТекВидОперации = НайтиВидОперации(Ст, ТекДокумент, Организация);
...
Процедура ОбработкаРезультатаВПоток(Таб, ПараметрыОтчета, Организация, Группа)
	...
	Если ПараметрыОтчета.НеФормироватьДанныеДляВыгрузки Тогда
		Возврат;
	КонецЕсли;
	...
	Для Каждого Стр Из Таб Цикл 
		Если Таб.Колонки.Найти("СуммаОборотДт") = Неопределено Тогда
			...
			ИначеЕсли Стр.Счет = "44" Тогда
				Запись.Документ = ПредопределенноеЗначение("Перечисление.ВидыВыгружаемыхДокументов.УслугиСтороннихОрганизаций");
			КонецЕсли;
...
Функция НайтиВидОперации(Стр, Документ, Организация)
	...
	Запрос.Текст = "ВЫБРАТЬ
				   ...
				   |	И ВидыОперацийВыгружаемыхВ7.ОплатаЗаКонтрагента = &ОплатаЗаКонтрагента";
	Запрос.УстановитьПараметр("Документ", Документ);


	Попытка
		Запрос.УстановитьПараметр("ОплатаЗаКонтрагента", ?(ЗначениеЗаполнено(Стр.ОплатаЗаКонтрагента),
			Справочники.Организации.НайтиПоРеквизиту("ИНН", Стр.ОплатаЗаКонтрагента),
			Справочники.Организации.ПустаяСсылка())
		);
	Исключение
		Запрос.Текст = СтрЗаменить(Запрос.Текст, "И ВидыОперацийВыгружаемыхВ7.ОплатаЗаКонтрагента = &ОплатаЗаКонтрагента", "");
	КонецПопытки;
...
Функция СоздатьЗаписьНастроек(Стр, Документ) 
	...
	Попытка
		спр.ОплатаЗаКонтрагента = ?(ЗначениеЗаполнено(Стр.ОплатаЗаКонтрагента),
		Справочники.Организации.НайтиПоРеквизиту("ИНН", Стр.ОплатаЗаКонтрагента),
		Неопределено
	);
	Исключение
	...
	Для Сч = 0 По Метаданные.Справочники.ВидыОперацийВыгружаемыхВ7.Реквизиты.Количество()-1 Цикл
		Попытка	
			...
			стрНаименование = стрНаименование + ", " + ?(
				ТипЗнч(Стр[Метаданные.Справочники.ВидыОперацийВыгружаемыхВ7.Реквизиты[Сч].Имя]) = Тип("Булево") 
					И ЗначениеЗаполнено(Стр[Метаданные.Справочники.ВидыОперацийВыгружаемыхВ7.Реквизиты[Сч].Имя]),
			//	?(Стр[Сч], Метаданные.Справочники.ВидыОперацийВыгружаемыхВ7.Реквизиты[Сч+1].Имя, ""),
				Метаданные.Справочники.ВидыОперацийВыгружаемыхВ7.Реквизиты[Сч].Имя,
				Стр[Сч]
			);
		Исключение
			Продолжить;
...
Функция ТекстЗапроса(БазаУТП = Ложь) Экспорт

	Текст = "ВЫБРАТЬ
|	""51"" КАК Счет,
|	ВЫБОР
|		КОГДА &БазаУТП ТОГДА ХозрасчетныйОбороты.КорСчет.Код
...
|	КОНЕЦ КАК СвояФирма,
|"+?(БазаУТП, "NULL", "
|	ВЫБОР КОГДА НЕ КонтрагентСсылкаГруппы1.Значение = ЗНАЧЕНИЕ(Справочник.Контрагенты.ПустаяСсылка) ТОГДА
|		КонтрагентСсылкаГруппы1.Значение.ИНН
|		КОГДА НЕ КонтрагентСсылкаГруппы2.Значение = ЗНАЧЕНИЕ(Справочник.Контрагенты.ПустаяСсылка) ТОГДА
|		КонтрагентСсылкаГруппы2.Значение.ИНН
|		КОГДА НЕ КонтрагентСсылкаГруппы3.Значение = ЗНАЧЕНИЕ(Справочник.Контрагенты.ПустаяСсылка) ТОГДА
|		КонтрагентСсылкаГруппы3.Значение.ИНН
|		КОГДА НЕ КонтрагентСсылкаГруппы4.Значение = ЗНАЧЕНИЕ(Справочник.Контрагенты.ПустаяСсылка) ТОГДА
|		КонтрагентСсылкаГруппы4.Значение.ИНН
|		КОГДА НЕ КонтрагентСсылкаГруппы5.Значение = ЗНАЧЕНИЕ(Справочник.Контрагенты.ПустаяСсылка) ТОГДА
|		КонтрагентСсылкаГруппы5.Значение.ИНН
|		ИНАЧЕ
|			""""
|	КОНЕЦ")+" КАК ОплатаЗаКонтрагента
|ИЗ
|	РегистрБухгалтерии.Хозрасчетный.Обороты(&НачалоПериода, &КонецПериода, Месяц, Счет В ИЕРАРХИИ (ЗНАЧЕНИЕ(ПланСчетов.Хозрасчетный.РасчетныеСчета)), , "+?(БазаУТП, "", "Организация.ИНН = &Организация")+", НЕ КорСчет В ИЕРАРХИИ (ЗНАЧЕНИЕ(ПланСчетов.Хозрасчетный.РасчетныеСчета)), ) КАК ХозрасчетныйОбороты
|"+?(БазаУТП, "", "		ЛЕВОЕ СОЕДИНЕНИЕ Справочник.Контрагенты.ДополнительныеРеквизиты КАК КонтрагентыДополнительныеРеквизиты
...
|
|		ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.ДополнительныеСведения КАК КонтрагентСсылкаГруппы1
|			ВНУТРЕННЕЕ СОЕДИНЕНИЕ ПланВидовХарактеристик.ДополнительныеРеквизитыИСведения КАК ДопРек1
|			ПО (ДопРек1.Ссылка = КонтрагентСсылкаГруппы1.Свойство)
|				И (ДопРек1.Наименование = ""Контрагент"")
|		ПО ХозрасчетныйОбороты.КорСубконто1.Ссылка.Родитель = КонтрагентСсылкаГруппы1.Объект
|		ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.ДополнительныеСведения КАК КонтрагентСсылкаГруппы2
|			ВНУТРЕННЕЕ СОЕДИНЕНИЕ ПланВидовХарактеристик.ДополнительныеРеквизитыИСведения КАК ДопРек2
|			ПО (ДопРек2.Ссылка = КонтрагентСсылкаГруппы2.Свойство)
|				И (ДопРек2.Наименование = ""Контрагент"")
|		ПО ХозрасчетныйОбороты.КорСубконто1.Ссылка.Родитель.Родитель = КонтрагентСсылкаГруппы2.Объект
|		ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.ДополнительныеСведения КАК КонтрагентСсылкаГруппы3
|			ВНУТРЕННЕЕ СОЕДИНЕНИЕ ПланВидовХарактеристик.ДополнительныеРеквизитыИСведения КАК ДопРек3
|			ПО (ДопРек3.Ссылка = КонтрагентСсылкаГруппы3.Свойство)
|				И (ДопРек3.Наименование = ""Контрагент"")
|		ПО ХозрасчетныйОбороты.КорСубконто1.Ссылка.Родитель.Родитель.Родитель = КонтрагентСсылкаГруппы3.Объект
|		ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.ДополнительныеСведения КАК КонтрагентСсылкаГруппы4
|			ВНУТРЕННЕЕ СОЕДИНЕНИЕ ПланВидовХарактеристик.ДополнительныеРеквизитыИСведения КАК ДопРек4
|			ПО (ДопРек4.Ссылка = КонтрагентСсылкаГруппы4.Свойство)
|				И (ДопРек4.Наименование = ""Контрагент"")
|		ПО ХозрасчетныйОбороты.КорСубконто1.Ссылка.Родитель.Родитель.Родитель.Родитель = КонтрагентСсылкаГруппы4.Объект
|		ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.ДополнительныеСведения КАК КонтрагентСсылкаГруппы5
|			ВНУТРЕННЕЕ СОЕДИНЕНИЕ ПланВидовХарактеристик.ДополнительныеРеквизитыИСведения КАК ДопРек5
|			ПО (ДопРек5.Ссылка = КонтрагентСсылкаГруппы5.Свойство)
|				И (ДопРек5.Наименование = ""Контрагент"")
|		ПО ХозрасчетныйОбороты.КорСубконто1.Ссылка.Родитель.Родитель.Родитель.Родитель.Родитель = КонтрагентСсылкаГруппы5.Объект
|
|")+"
|СГРУППИРОВАТЬ ПО 
|"+?(БазаУТП, "", "
...
|	NULL
|ИЗ
|	РегистрБухгалтерии.Хозрасчетный.Обороты(&НачалоПериода, &КонецПериода, Месяц, Счет В ИЕРАРХИИ (ЗНАЧЕНИЕ(ПланСчетов.Хозрасчетный.Касса)), , "+?(БазаУТП, "", "Организация.ИНН = &Организация И #ФормироватьКассу")+", НЕ КорСчет В ИЕРАРХИИ (ЗНАЧЕНИЕ(ПланСчетов.Хозрасчетный.Касса)), ) КАК ХозрасчетныйОбороты
|"+?(БазаУТП, "", "
...
Функция Зарплата(Прокси, ПараметрыОтчета, Организация, ТабличныйДокумент, Макет, Курс)
	...
	Запрос.Параметры.Вставить("Организация",   Организация.ИНН);
	Запрос.Параметры.Вставить("Счет", РегистрыСведений.Меппинг.ПолучитьЗамену(Организация, "70"));  // РасчетыСПерсоналомПоОплатеТруда
	Запрос.Параметры.Вставить("СписокКорСчетов", РегистрыСведений.Меппинг.ПолучитьЗамену(Организация, "51"));
	Запрос.ТекстЗапроса = "
		|ВЫБРАТЬ
	...
	Если Организация.БазаУТП Тогда
		Запрос.ТекстЗапроса = СтрЗаменить(Запрос.ТекстЗапроса, "Организация.ИНН = &Организация", "");
	КонецЕсли;
	...
	Ответ.Результат = ПересчитатьТаблицуПоКурсу(Ответ.Результат, "СуммаНалога", Курс);
	...
	Если НЕ Ответ.Ошибка Тогда
		Если Ответ.Результат.Количество() > 0 Тогда
			...
			Если Организация = Справочники.Организации.НайтиПоРеквизиту("ИНН", "7807220663") Тогда
				НоваяСтрока = ПараметрыОтчета.Итоги.ОстаткиОбороты.Добавить();
				НоваяСтрока.Фирма = СокрЛП(Организация);
				НоваяСтрока.РасходОфис = ТаблицаЗП.Итог("СуммаНалога");
				
				НоваяСтрока = ПараметрыОтчета.Итоги.ОборотыОфис.Добавить();
				НоваяСтрока.Фирма = СокрЛП(Организация);
				НоваяСтрока.СуммаРасход = ТаблицаЗП.Итог("СуммаНалога");
			Иначе
				НоваяСтрока = ПараметрыОтчета.Итоги.ОстаткиОбороты.Добавить();
				НоваяСтрока.Фирма = СокрЛП(Организация);
				НоваяСтрока.РасходЗП = ТаблицаЗП.Итог("СуммаНалога");
			КонецЕсли;

		КонецЕсли;
	Иначе
		ВызватьИсключение("Ошибка при формировании отчета по " + Организация + Символы.ПС + Ответ.ОписаниеОшибки);
	КонецЕсли;
...
Функция ИсполнительныеЛисты(Прокси, ПараметрыОтчета, Организация, ТабличныйДокумент, Макет, Курс)
	
	Запрос = мммСервер.ЗапросПрокси();
	Запрос.Параметры.Вставить("ДатаНачала",    НачалоДня(ПараметрыОтчета.НачалоПериода));
	Запрос.Параметры.Вставить("ДатаОкончания", Новый Граница(КонецДня(ПараметрыОтчета.КонецПериода), ВидГраницы.Включая));
	Запрос.Параметры.Вставить("Организация",   Организация.ИНН);
	Запрос.Параметры.Вставить("Счет", РегистрыСведений.Меппинг.ПолучитьЗамену(Организация, "76.41"));  // РасчетыПоИсполнительнымДокументамРаботников
	Запрос.Параметры.Вставить("СписокКорСчетов", РегистрыСведений.Меппинг.ПолучитьЗамену(Организация, "51"));
	Запрос.ТекстЗапроса = "
		|ВЫБРАТЬ
		|	Хозрасчетный.Ссылка КАК Счет
	...
	Если НЕ Ответ.Ошибка Тогда
		Если Ответ.Результат.Количество() > 0 Тогда
			...
			Если Организация = Справочники.Организации.НайтиПоРеквизиту("ИНН", "7807220663") Тогда
				НоваяСтрока = ПараметрыОтчета.Итоги.ОстаткиОбороты.Добавить();
				НоваяСтрока.Фирма = СокрЛП(Организация);
				НоваяСтрока.РасходОфис = ТаблицаИЛ.Итог("СуммаНалога");
				
				НоваяСтрока = ПараметрыОтчета.Итоги.ОборотыОфис.Добавить();
				НоваяСтрока.Фирма = СокрЛП(Организация);
				НоваяСтрока.СуммаРасход = ТаблицаИЛ.Итог("СуммаНалога");
			Иначе
				НоваяСтрока = ПараметрыОтчета.Итоги.ОстаткиОбороты.Добавить();
				НоваяСтрока.Фирма = СокрЛП(Организация);
				НоваяСтрока.РасходЗП = ТаблицаИЛ.Итог("СуммаНалога");
			КонецЕсли;
...
Функция Налоги(Прокси, ПараметрыОтчета, Организация, ТабличныйДокумент, Макет, Курс)
	
		МассивКорСчетов = Новый Массив;
		МассивКорСчетов.Добавить(РегистрыСведений.Меппинг.ПолучитьЗамену(Организация, "68"));//(ПланыСчетов.Хозрасчетный.РасчетыПоНалогам);
		МассивКорСчетов.Добавить(РегистрыСведений.Меппинг.ПолучитьЗамену(Организация, "69"));//(ПланыСчетов.Хозрасчетный.РасчетыПоСоциальномуСтрахованию);
		
		Запрос = мммСервер.ЗапросПрокси();
		Запрос.Параметры.Вставить("ДатаНачала", НачалоДня(ПараметрыОтчета.НачалоПериода));
		Запрос.Параметры.Вставить("ДатаОкончания", Новый Граница(КонецДня(ПараметрыОтчета.КонецПериода), ВидГраницы.Включая));
		Запрос.Параметры.Вставить("Организация", Организация.ИНН);
		Запрос.Параметры.Вставить("Счет", РегистрыСведений.Меппинг.ПолучитьЗамену(Организация, "51")); //		   ПланыСчетов.Хозрасчетный.РасчетныеСчета);
	...
	Если НЕ Ответ.Ошибка Тогда
		Если Ответ.Результат.Количество() > 0 Тогда
			...
			НоваяСтрока = ПараметрыОтчета.Итоги.ОстаткиОбороты.Добавить();
			НоваяСтрока.Фирма = СокрЛП(Организация);
			НоваяСтрока.РасходНалоги = ТаблицаНалогов.Итог("СуммаНалога");
...
Функция Материалы(Прокси, ПараметрыОтчета, Организация, ТабличныйДокумент, Макет, Группа, Курс)
	...
	Запрос.Параметры.Вставить("Счет", РегистрыСведений.Меппинг.ПолучитьЗамену(Организация, "60"));		//ПланыСчетов.Хозрасчетный.РасчетыСПоставщикамиИПодрядчиками);
	Запрос.Параметры.Вставить("КорСчет", РегистрыСведений.Меппинг.ПолучитьЗамену(Организация, "51"));		//      ПланыСчетов.Хозрасчетный.РасчетныеСчета);
	...
	Ответ.Результат = ПересчитатьТаблицуПоКурсу(Ответ.Результат, "СуммаПоступленийМатериалов,СуммаОплатМатериалов", Курс);
	...
	Если НЕ Ответ.Ошибка Тогда
		Если Ответ.Результат.Количество() > 0 Тогда
			...
			Для Каждого Стр Из ТаблицаМатериалов Цикл
				...
				НоваяСтрока = ПараметрыОтчета.Итоги.ОстаткиОбороты.Добавить();
				НоваяСтрока.Фирма = СокрЛП(Организация);
				//НоваяСтрока.ПриходМатериалы = Стр.СуммаПоступленийМатериалов;
				НоваяСтрока.РасходМатериалы = Стр.СуммаОплатМатериалов;
				
				НоваяСтрока = ПараметрыОтчета.Итоги.ОборотыМатериалы.Добавить();
				НоваяСтрока.Фирма = СокрЛП(Организация);
				НоваяСтрока.СуммаРасход = Стр.СуммаОплатМатериалов;
			КонецЦикла; 
			...
			НоваяСтрока = ПараметрыОтчета.Итоги.ОборотыМатериалы.Добавить();
			НоваяСтрока.Фирма = СокрЛП(Организация);
			НоваяСтрока.СуммаПриход = ТаблицаМатериалов.Итог("СуммаПоступленийМатериалов");
...
Функция Услуги(Прокси, ПараметрыОтчета, Организация, ТабличныйДокумент, Макет, Курс, ИтогоСуммаНалога = 0)
	...
	Запрос.Параметры.Вставить("Счет", РегистрыСведений.Меппинг.ПолучитьЗамену(Организация, "60"));		//ПланыСчетов.Хозрасчетный.РасчетыСПоставщикамиИПодрядчиками);
	Запрос.Параметры.Вставить("КорСчет", РегистрыСведений.Меппинг.ПолучитьЗамену(Организация, "51"));		//      ПланыСчетов.Хозрасчетный.РасчетныеСчета);
	Запрос.Параметры.Вставить("Счет91", РегистрыСведений.Меппинг.ПолучитьЗамену(Организация, "91"));		//
	Запрос.ТекстЗапроса = 
		"		ВЫБРАТЬ	
		|			Контрагенты.Ссылка КАК Ссылка
		|		ПОМЕСТИТЬ ВТКонтрагенты
		...
		|			ПланСчетов.Хозрасчетный КАК Хозрасчетный
		|		ГДЕ
		|			(Хозрасчетный.Код В (&Счет91)
		|					ИЛИ Хозрасчетный.Родитель.Код В (&Счет91)
		|					ИЛИ Хозрасчетный.Родитель.Родитель.Код В (&Счет91)
		|					ИЛИ Хозрасчетный.Родитель.Родитель.Родитель.Код В (&Счет91))
		|		;
		|
		|		
		|		////////////////////////////////////////////////////////////////////////////////
		...
		|					Организация.ИНН = &Организация,
		|					КорСчет В (Выбрать Т.Счет ИЗ ВТСчет91 КАК Т),
		|					) КАК ХозрасчетныйОбороты
		|		ГДЕ
		|			ХозрасчетныйОбороты.Субконто1 В "+ ?(Организация.БазаУТП,"(ВЫБРАТЬ Т.Ссылка ИЗ Справочник.СтатьиДвиженияДенежныхСредств КАК Т ГДЕ Т.Наименование = ""УслугиБанков"")","(ЗНАЧЕНИЕ(Справочник.СтатьиДвиженияДенежныхСредств.УслугиБанков))")+"
		|		
		|		СГРУППИРОВАТЬ ПО
		|			ХозрасчетныйОбороты.Субконто1
		|		
		...
		|";
	Если Организация.БазаУТП Тогда
		Запрос.ТекстЗапроса = СтрЗаменить(Запрос.ТекстЗапроса, "И Организация.ИНН = &Организация", "");
		Запрос.ТекстЗапроса = СтрЗаменить(Запрос.ТекстЗапроса, "Организация.ИНН = &Организация", "");
	КонецЕсли;
	...
	Ответ.Результат = ПересчитатьТаблицуПоКурсу(Ответ.Результат, "СуммаУслуг", Курс);
	...
	Если НЕ Ответ.Ошибка Тогда
		Если Ответ.Результат.Количество() > 0 Тогда
			...
			ОбластьМакета.Параметры.СуммаНалога = ИтогоСуммаНалога;
			ТабличныйДокумент.Вывести(ОбластьМакета);
			
			НоваяСтрока = ПараметрыОтчета.Итоги.ОстаткиОбороты.Добавить();
			НоваяСтрока.Фирма = СокрЛП(Организация);
			НоваяСтрока.РасходУслуги = ТаблицаУслуг.Итог("СуммаУслуг");
...
Функция Займы(Прокси, ПараметрыОтчета, Организация, ТабличныйДокумент, Макет, Курс)
	...
	Запрос.Параметры.Вставить("Счет", РегистрыСведений.Меппинг.ПолучитьЗамену(Организация, "58"));		//ПланыСчетов.Хозрасчетный.РасчетыСПоставщикамиИПодрядчиками);
	Запрос.Параметры.Вставить("КорСчет", РегистрыСведений.Меппинг.ПолучитьЗамену(Организация, "51"));		//      ПланыСчетов.Хозрасчетный.РасчетныеСчета);
	Запрос.ТекстЗапроса = 
		"ВЫБРАТЬ
		|	Хозрасчетный.Ссылка КАК Счет
	...
	Если НЕ Ответ.Ошибка Тогда
		Если Ответ.Результат.Количество() > 0 Тогда
			...
			// итоги
			НоваяСтрока = ПараметрыОтчета.Итоги.ОборотыМальч.Добавить();
			НоваяСтрока.Фирма = Организация;
			НоваяСтрока.СуммаРасход = ИтогоЗаймы;
			
			НоваяСтрока = ПараметрыОтчета.Итоги.ОстаткиОбороты.Добавить();
			НоваяСтрока.Фирма = СокрЛП(Организация);
			НоваяСтрока.РасходМальч = ИтогоЗаймы;
...
Функция КонтрагентыДополнительныеРеквизиты(Прокси, ПараметрыОтчета, Организация, ТабличныйДокумент, Макет, ИтСуммаДоп, Курс)
	...
	МассивСчетов5.Добавить(РегистрыСведений.Меппинг.ПолучитьЗамену(Организация, "60"));//ПланыСчетов.Хозрасчетный.РасчетыСПоставщикамиИПодрядчиками);
	МассивСчетов5.Добавить(РегистрыСведений.Меппинг.ПолучитьЗамену(Организация, "76"));//ПланыСчетов.Хозрасчетный.РасчетыСРазнымиДебиторамиИКредиторами);	
	МассивСчетов5.Добавить(РегистрыСведений.Меппинг.ПолучитьЗамену(Организация, "73"));
	МассивСчетов5.Добавить(РегистрыСведений.Меппинг.ПолучитьЗамену(Организация, "58"));
	...
	Запрос.ТекстЗапроса = "ВЫБРАТЬ
		...
		|
|ГДЕ НЕ (ХозрасчетныйОбороты.Счет.Родитель.Код В (""73""))
|
|ОБЪЕДИНИТЬ ВСЕ
|
|ВЫБРАТЬ
|	ПРЕДСТАВЛЕНИЕ(ХозрасчетныйОбороты.Субконто1) КАК ВидНалога,
|	ВЫРАЗИТЬ(ХозрасчетныйОбороты.Субконто1 КАК Справочник.ФизическиеЛица).ИНН КАК ВидНалогаИНН,
|	ХозрасчетныйОбороты.СуммаОборотДт КАК СуммаУслуг,
|	""Офис"" КАК ТипКлиента
|ИЗ
...
|	ЛЕВОЕ СОЕДИНЕНИЕ Справочник.Контрагенты.ДополнительныеРеквизиты КАК КонтрагентыДополнительныеРеквизиты
|	ПО ХозрасчетныйОбороты.Субконто1 = КонтрагентыДополнительныеРеквизиты.Ссылка
|ГДЕ ХозрасчетныйОбороты.Счет.Родитель.Код В (""73"")
|
		|ИТОГИ
		|	СУММА(СуммаУслуг)
		|ПО
			...
			Для Каждого Стр Из ТаблицаУслуг2 Цикл
				Если Не ЗначениеЗаполнено(Стр.ВидНалога) Тогда
					...
					Если СокрЛП(Стр.ТипКлиента) = "Офис" Тогда
						НоваяСтрока = ПараметрыОтчета.Итоги.ОборотыОфис.Добавить();
						НоваяСтрока.Фирма = СокрЛП(Организация);
						НоваяСтрока.СуммаРасход = Стр.СуммаУслуг;
						
						НоваяСтрока = ПараметрыОтчета.Итоги.ОстаткиОбороты.Добавить();
						НоваяСтрока.Фирма = СокрЛП(Организация);
						НоваяСтрока.РасходОфис = Стр.СуммаУслуг;
						
					ИначеЕсли СокрЛП(Стр.ТипКлиента) = "Фирмы универсама" Тогда
						НоваяСтрока = ПараметрыОтчета.Итоги.ОстаткиОбороты.Добавить();
						НоваяСтрока.Фирма = СокрЛП(Организация);
						НоваяСтрока.РасходУниверс = Стр.СуммаУслуг;
					Иначе
						НоваяСтрока = ПараметрыОтчета.Итоги.ОстаткиОбороты.Добавить();
						НоваяСтрока.Фирма = СокрЛП(Организация);
						НоваяСтрока.РасходПрочие = Стр.СуммаУслуг;
					КонецЕсли;
				Иначе
					ОбластьМакета = Макет.ПолучитьОбласть("СтрокаОтчета");
					
					//Если СокрЛП(Стр.ТипКлиента) = "Фирмы универсама" Тогда
					//	ОбластьМакета = Макет.ПолучитьОбласть("СтрокаОтчетаЗ");
					//ИначеЕсли СокрЛП(Стр.ТипКлиента) = "Офис" Тогда
					//	ОбластьМакета = Макет.ПолучитьОбласть("СтрокаОтчетаС");
					//КонецЕсли;
...
Функция Проверка(Прокси, ТабличныйДокумент, Макет, ПараметрыОтчета, Организация, Курс)
	...
	Ответ.Результат = ПересчитатьТаблицуПоКурсу(Ответ.Результат, "СуммаПроверки", Курс);

	Если НЕ Ответ.Ошибка Тогда
	//	Если Ответ.Результат.Количество() > 0 Тогда	
			РезультатЗапроса = Ответ.Результат;	
			ОбластьМакетаПроверка.Параметры.СуммаПроверки = РезультатЗапроса.Итог("СуммаПроверки");
			СуммаПроверки = РезультатЗапроса.Итог("СуммаПроверки");
	//	КонецЕсли;
	Иначе
		ВызватьИсключение("Ошибка при формировании отчета по " + Организация + Символы.ПС + Ответ.ОписаниеОшибки);
	КонецЕсли;
	...
	Возврат СуммаПроверки;
	
КонецФункции

Процедура ВетСправка(Прокси, ТабличныйДокумент, Макет, ПараметрыОтчета, Организация, Курс)
	...
	Запрос.Параметры.Вставить("ДатаОкончания", Новый Граница(КонецДня(ПараметрыОтчета.КонецПериода), ВидГраницы.Включая));
	Запрос.Параметры.Вставить("Организация",   Организация.ИНН);
	Запрос.Параметры.Вставить("Счет", РегистрыСведений.Меппинг.ПолучитьЗамену(Организация, "44.03"));
	...
	Ответ.Результат = ПересчитатьТаблицуПоКурсу(Ответ.Результат, "СуммаВетСправка", Курс);

	Если НЕ Ответ.Ошибка Тогда

		РезультатЗапроса = Ответ.Результат;
		СуммаВетСправка = РезультатЗапроса.Итог("СуммаВетСправка")*1.2;
		ОбластьВетСправка.Параметры.СуммаВетСправка = СуммаВетСправка;
		
		НоваяСтрока = ПараметрыОтчета.Итоги.ОстаткиОбороты.Добавить();
		НоваяСтрока.Фирма = СокрЛП(Организация);
		НоваяСтрока.РасходВетСправка = СуммаВетСправка;

		// к выгрузке
		Если Не СуммаВетСправка = 0 Тогда
			тз = РегистрыСведений.ДанныеКВыгрузкеВ7.СоздатьНаборЗаписей().ВыгрузитьКолонки();
			тз.Колонки.Добавить("СуммаОборот", Новый ОписаниеТипов("Число"));
			НоваяСтрока = тз.Добавить();
			НоваяСтрока.Период = НачалоМесяца(ПараметрыОтчета.НачалоПериода);
			...
			Группа = "";
			НоваяСтрока.Счет = "44";
			НоваяСтрока.СуммаОборот = СуммаВетСправка;
...
Функция НеВошедшиеКонтрагентыПоУслугам(Прокси, ПараметрыОтчета, Организация, ТабличныйДокумент, Макет, Курс)
	...
	ВыполняемыйКод = "ГруппаКонтрагентовЗатраты=Справочники.Контрагенты.НайтиПоНаименованию(""ЗАТРАТЫ"",Истина,,);
		...
		|ВыбСчет.Добавить(ПланыСчетов.Хозрасчетный."+РегистрыСведений.Меппинг.ПолучитьЗамену(Организация, "РасчетыСПоставщикамиИПодрядчиками")+"); //60
		|ВыбСчет.Добавить(ПланыСчетов.Хозрасчетный."+РегистрыСведений.Меппинг.ПолучитьЗамену(Организация, "РасчетыСУчредителями")+"); //75
		|ВыбСчет.Добавить(ПланыСчетов.Хозрасчетный."+РегистрыСведений.Меппинг.ПолучитьЗамену(Организация, "РасчетыСПодотчетнымиЛицами_")+"); //71
		|ВыбСчет.Добавить(ПланыСчетов.Хозрасчетный."+РегистрыСведений.Меппинг.ПолучитьЗамену(Организация, "ПрочиеРасчетыСРазнымиДебиторамиИКредиторами")+"); //76.09
		//|ВыбСчет.Добавить(ПланыСчетов.Хозрасчетный."+РегистрыСведений.Меппинг.ПолучитьЗамену(Организация, "РасчетыПоКраткосрочнымКредитамИЗаймам")+");
		|Запрос.УстановитьПараметр(""ВидыСубконто"", ПланыВидовХарактеристик.ВидыСубконтоХозрасчетные.Контрагенты);
		|Запрос.УстановитьПараметр(""ВыбСчет"", ВыбСчет);//ПланыСчетов.Хозрасчетный."+РегистрыСведений.Меппинг.ПолучитьЗамену(Организация, "РасчетыСПоставщикамиИПодрядчиками")+");
		|Запрос.УстановитьПараметр(""КорСчет"", ПланыСчетов.Хозрасчетный."+РегистрыСведений.Меппинг.ПолучитьЗамену(Организация, "РасчетныеСчета")+");
	...
	//	||			&ВидыСубконто
		...
		||			ПО (ДопРек1.Ссылка = КонтрагентСсылкаГруппы1.Свойство)
		||				И (ДопРек1.Наименование = """"Контрагент"""")
		||		ПО ХозрасчетныйОбороты.Субконто1.Ссылка.Родитель = КонтрагентСсылкаГруппы1.Объект
		||		ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.ДополнительныеСведения КАК КонтрагентСсылкаГруппы2
		||			ВНУТРЕННЕЕ СОЕДИНЕНИЕ ПланВидовХарактеристик.ДополнительныеРеквизитыИСведения КАК ДопРек2
		||			ПО (ДопРек2.Ссылка = КонтрагентСсылкаГруппы2.Свойство)
		||				И (ДопРек2.Наименование = """"Контрагент"""")
		||		ПО ХозрасчетныйОбороты.Субконто1.Ссылка.Родитель.Родитель = КонтрагентСсылкаГруппы2.Объект
		||		ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.ДополнительныеСведения КАК КонтрагентСсылкаГруппы3
		||			ВНУТРЕННЕЕ СОЕДИНЕНИЕ ПланВидовХарактеристик.ДополнительныеРеквизитыИСведения КАК ДопРек3
		||			ПО (ДопРек3.Ссылка = КонтрагентСсылкаГруппы3.Свойство)
		||				И (ДопРек3.Наименование = """"Контрагент"""")
		||		ПО ХозрасчетныйОбороты.Субконто1.Ссылка.Родитель.Родитель.Родитель = КонтрагентСсылкаГруппы3.Объект
		||		ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.ДополнительныеСведения КАК КонтрагентСсылкаГруппы4
		||			ВНУТРЕННЕЕ СОЕДИНЕНИЕ ПланВидовХарактеристик.ДополнительныеРеквизитыИСведения КАК ДопРек4
		||			ПО (ДопРек4.Ссылка = КонтрагентСсылкаГруппы4.Свойство)
		||				И (ДопРек4.Наименование = """"Контрагент"""")
		||		ПО ХозрасчетныйОбороты.Субконто1.Ссылка.Родитель.Родитель.Родитель.Родитель = КонтрагентСсылкаГруппы4.Объект
		||		ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.ДополнительныеСведения КАК КонтрагентСсылкаГруппы5
		||			ВНУТРЕННЕЕ СОЕДИНЕНИЕ ПланВидовХарактеристик.ДополнительныеРеквизитыИСведения КАК ДопРек5
		||			ПО (ДопРек5.Ссылка = КонтрагентСсылкаГруппы5.Свойство)
		||				И (ДопРек5.Наименование = """"Контрагент"""")
		||		ПО ХозрасчетныйОбороты.Субконто1.Ссылка.Родитель.Родитель.Родитель.Родитель.Родитель = КонтрагентСсылкаГруппы5.Объект
		||
		||")+"
		||ГДЕ
		...
		|ВозвращаемоеЗначение.Колонки.Добавить(""ОплатаЗаКонтрагента"");
		|Для Каждого Стр Из ТаблицаУслуг Цикл
		...
		|			НоваяСтр.ПоставщикиТовара = Истина;
		|		КонецЕсли;
		|		НоваяСтр.ОплатаЗаКонтрагента = Стр.ОплатаЗаКонтрагента;
		|	КонецЕсли;
		|КонецЦикла;";
	Если Организация.БазаУТП Тогда
		ВыполняемыйКод = СтрЗаменить(ВыполняемыйКод, "И Организация.ИНН = &Организация", "");
		ВыполняемыйКод = СтрЗаменить(ВыполняемыйКод, "СтрНайти", "Найти");
	КонецЕсли;
	...
	ТаблицаУслуг = ПересчитатьТаблицуПоКурсу(ТаблицаУслуг, "СуммаУслуг", Курс);

	Если НЕ Ответ.Ошибка Тогда
		
		ТаблицаСвоихФирм = ПолучитьТаблицуСвоихФирм(Организация, ПараметрыОтчета.КонецПериода);
	...
	//				ТабличныйДокумент.Вывести(ОбластьМакетаГруппаКлиентов,Стр.Уровень);
				Иначе
					...
					//Если ТаблицаСвоихФирм.Найти(Стр.ИНН, "ИНН") <> Неопределено И Не ЗначениеЗаполнено(Стр.ОплатаЗаКонтрагента) Тогда
					//	ОбластьМакетаКлиентов = Макет.ПолучитьОбласть("НеВошедшиеКонтрагентыПоУслугамЗ");
					//Иначе
					//	ОбластьМакетаКлиентов = Макет.ПолучитьОбласть("НеВошедшиеКонтрагентыПоУслугам");
					//КонецЕсли;
	...
	//				ТабличныйДокумент.Вывести(ОбластьМакетаКлиентов,Стр.Уровень);
					...
					///
					Если ЗначениеЗаполнено(Стр.ОплатаЗаКонтрагента) Тогда
						НоваяСтрока = ПараметрыОтчета.Итоги.ОстаткиОбороты.Добавить();
						НоваяСтрока.Фирма = СокрЛП(Организация);
						НоваяСтрока.РасходТройств = Стр.СуммаУслуг;
					ИначеЕсли ТаблицаСвоихФирм.Найти(Стр.ИНН, "ИНН") <> Неопределено И Не ЗначениеЗаполнено(Стр.ОплатаЗаКонтрагента) Тогда
					...
					Иначе
						...
						Иначе
							НоваяСтрока = ПараметрыОтчета.Итоги.ОстаткиОбороты.Добавить();
							НоваяСтрока.Фирма = СокрЛП(Организация);
							НоваяСтрока.РасходТовар = Стр.СуммаУслуг;
						КонецЕсли;
					КонецЕсли;
...
Процедура ВывестиНеВошедшиеКонтрагентыПоУслугам(Прокси, ПараметрыОтчета, Организация, ТабличныйДокумент, Макет, Курс, ТаблицаУслуг)

	Если Не ТипЗнч(ТаблицаУслуг) = Тип("ТаблицаЗначений") Тогда
		Возврат;
	КонецЕсли;
	
	Если Не ТаблицаУслуг.Количество() Тогда
		Возврат;
	КонецЕсли;
...
Процедура Запрос57(Прокси, ПараметрыОтчета, Организация, ТабличныйДокумент, Макет, Курс)
	...
	Запрос.Параметры.Вставить("ДатаОкончания", Новый Граница(КонецДня(ПараметрыОтчета.КонецПериода), ВидГраницы.Включая));
	Запрос.Параметры.Вставить("Организация",   Организация.ИНН);
	Запрос.Параметры.Вставить("КорСчет", РегистрыСведений.Меппинг.ПолучитьЗамену(Организация, "57"));//ПланыСчетов.Хозрасчетный.ПереводыВПути_);
	Запрос.Параметры.Вставить("Счет", РегистрыСведений.Меппинг.ПолучитьЗамену(Организация, "51"));//ПланыСчетов.Хозрасчетный.РасчетныеСчета);
	Запрос.ТекстЗапроса = "
		|ВЫБРАТЬ
		|	Хозрасчетный.Ссылка КАК Счет
		...
		Если Ответ.Результат.Количество() > 0 Тогда
			Для Каждого Выборка Из Ответ.Результат Цикл
				Если Выборка.СуммаУслуг > 0 Тогда
					...
					НоваяСтрока = ПараметрыОтчета.Итоги.ОстаткиОбороты.Добавить();
					НоваяСтрока.Фирма = СокрЛП(Организация);
					НоваяСтрока.Расход57 = Выборка.СуммаУслуг;
				КонецЕсли;	
			КонецЦикла;	
		КонецЕсли;
	Иначе
...
Процедура Запрос50(Прокси, ПараметрыОтчета, Организация, ТабличныйДокумент, Макет, Курс)
	...
	Запрос.Параметры.Вставить("ДатаОкончания", Новый Граница(КонецДня(ПараметрыОтчета.КонецПериода), ВидГраницы.Включая));
	Запрос.Параметры.Вставить("Организация",   Организация.ИНН);
	Запрос.Параметры.Вставить("КорСчет", РегистрыСведений.Меппинг.ПолучитьЗамену(Организация, "50"));//ПланыСчетов.Хозрасчетный.ПереводыВПути_);
	Запрос.Параметры.Вставить("Счет", РегистрыСведений.Меппинг.ПолучитьЗамену(Организация, "51"));//ПланыСчетов.Хозрасчетный.РасчетныеСчета);
	Запрос.ТекстЗапроса = "
		|ВЫБРАТЬ
		|	Хозрасчетный.Ссылка КАК Счет
	...
	Если НЕ Ответ.Ошибка Тогда
		Если Ответ.Результат.Количество() > 0 Тогда
			Для Каждого Выборка Из Ответ.Результат Цикл
				Если Выборка.СуммаУслуг > 0 Тогда
					ОбластьМакетаКлиентов.Параметры.Контрагент="Счет 50";
					ОбластьМакетаКлиентов.Параметры.СуммаУслуг=Выборка.СуммаУслуг;
					ТабличныйДокумент.Вывести(ОбластьМакетаКлиентов);
					
					НоваяСтрока = ПараметрыОтчета.Итоги.ОстаткиОбороты.Добавить();
					НоваяСтрока.Фирма = СокрЛП(Организация);
					НоваяСтрока.РасходКасса = Выборка.СуммаУслуг;
...
Процедура Запрос51(Прокси, ПараметрыОтчета, Организация, ТабличныйДокумент, Макет, Курс)
	...
	МассивКорСчетов.Добавить("55");
	Запрос.Параметры.Вставить("КорСчет", РегистрыСведений.Меппинг.ПолучитьЗамену(Организация, МассивКорСчетов));
	Запрос.Параметры.Вставить("Счет", РегистрыСведений.Меппинг.ПолучитьЗамену(Организация, "51"));
	Запрос.ТекстЗапроса = "
			|ВЫБРАТЬ
			|	Хозрасчетный.Ссылка КАК Счет
			|ПОМЕСТИТЬ ВТСчета
	...
	Если НЕ Ответ.Ошибка Тогда
		Если Ответ.Результат.Количество() > 0 Тогда
			Для Каждого Выборка Из Ответ.Результат Цикл
				Если НЕ Выборка.СуммаУслуг = 0 Тогда
					ОбластьМакетаКлиентов.Параметры.Контрагент="Счет 51";
					ОбластьМакетаКлиентов.Параметры.СуммаУслуг=Выборка.СуммаУслуг;
					ТабличныйДокумент.Вывести(ОбластьМакетаКлиентов);
					
					НоваяСтрока = ПараметрыОтчета.Итоги.ОстаткиОбороты.Добавить();
					НоваяСтрока.Фирма = СокрЛП(Организация);
					НоваяСтрока.Расход51 = Выборка.СуммаУслуг;
					
					Если Не Лев(Выборка.КорСчет,2) = "55" Тогда
						НоваяСтрока = ПараметрыОтчета.Итоги.ОстаткиОбороты.Добавить();
						НоваяСтрока.Фирма = СокрЛП(Организация);
						НоваяСтрока.Приход51 = Выборка.СуммаУслуг;
					КонецЕсли;
...
Процедура ТаблицаПоступлений(Прокси, ПараметрыОтчета, Организация, ТабличныйДокумент, Макет, Курс)
	...
	Запрос.Параметры.Вставить("ДатаОкончания", Новый Граница(КонецДня(ПараметрыОтчета.КонецПериода), ВидГраницы.Включая));
	Запрос.Параметры.Вставить("Организация",   Организация.ИНН);
	Запрос.Параметры.Вставить("ВыбСчет", РегистрыСведений.Меппинг.ПолучитьЗамену(Организация, "51"));  // РасчетныеСчета
	Запрос.ТекстЗапроса = "
		|ВЫБРАТЬ
		|	Хозрасчетный.Ссылка КАК Счет
		|ПОМЕСТИТЬ ВТСчета
	...
	Ответ.Результат = ПересчитатьТаблицуПоКурсу(Ответ.Результат, "СуммаНачало,СуммаКонец,СуммаПриход,СуммаРасход", Курс);
	...
	Если НЕ Ответ.Ошибка Тогда
		...
		//	ОбластьМакета = Макет.ПолучитьОбласть("ДноПоступлений");
			Для Каждого Стр Из ТаблицаОстатков Цикл
				...
				// Итоги
				ЗаполнитьЗначенияСвойств(ПараметрыОтчета.Итоги.ОстаткиОборотыОбщ.Добавить(), Стр);
				НоваяСтрока = ПараметрыОтчета.Итоги.ОстаткиОбороты.Добавить();
	...
	Запрос.Параметры.Вставить("ДатаОкончания", Новый Граница(КонецДня(ПараметрыОтчета.КонецПериода), ВидГраницы.Включая));
	Запрос.Параметры.Вставить("Организация",   Организация.ИНН);
	Запрос.Параметры.Вставить("Счет", РегистрыСведений.Меппинг.ПолучитьЗамену(Организация, "51"));  // РасчетныеСчета
	Запрос.ТекстЗапроса = "
		|ВЫБРАТЬ
		|	Хозрасчетный.Ссылка КАК Счет
		|ПОМЕСТИТЬ ВТСчета
		...
		|	ХозрасчетныйОбороты.КорСчет.Код КАК КорСчет,
		|	ПРЕДСТАВЛЕНИЕ(ХозрасчетныйОбороты.КорСубконто1) КАК КорСубконто,
		|	ВЫБОР КОГДА ХозрасчетныйОбороты.КорСубконто1 ССЫЛКА Справочник.Контрагенты ТОГДА ХозрасчетныйОбороты.КорСубконто1.ИНН ИНАЧЕ """" КОНЕЦ КАК КорСубконтоИНН,
		...
		|	"+ ?(Организация.БазаУТП, "NULL","КонтрагентыДополнительныеРеквизиты.Значение.Наименование")+" КАК ТипКонтрагента
		|ИЗ
		|	РегистрБухгалтерии.Хозрасчетный.Обороты(
		|			&ДатаНачала,
		|			&ДатаОкончания,
		...
		|	ХозрасчетныйОбороты.КорСубконто1,
		|	ХозрасчетныйОбороты.Субконто1,
		|	ВЫБОР КОГДА ХозрасчетныйОбороты.КорСубконто1 ССЫЛКА Справочник.Контрагенты ТОГДА ХозрасчетныйОбороты.КорСубконто1.ИНН ИНАЧЕ """" КОНЕЦ
		|	"+ ?(Организация.БазаУТП,"",",КонтрагентыДополнительныеРеквизиты.Значение.Наименование")+"
		|АВТОУПОРЯДОЧИВАНИЕ";
	Если Организация.БазаУТП Тогда
		Запрос.ТекстЗапроса = СтрЗаменить(Запрос.ТекстЗапроса, "И Организация.ИНН = &Организация", "");
		Запрос.ТекстЗапроса = СтрЗаменить(Запрос.ТекстЗапроса, "Организация.ИНН = &Организация", "");
	...
	Ответ.Результат = ПересчитатьТаблицуПоКурсу(Ответ.Результат, "СуммаПрихода", Курс);
	...
	Если НЕ Ответ.Ошибка Тогда
		Если Ответ.Результат.Количество() > 0 Тогда
			...
			Для Каждого Стр Из ТаблицаПоступлений Цикл
				...
				// Итог
				Если Лев(Стр.КорСчет, 2) = "50" Тогда		// ПриходКасса
					НоваяСтрока = ПараметрыОтчета.Итоги.ОстаткиОбороты.Добавить();
					НоваяСтрока.Фирма = СокрЛП(Организация);
					НоваяСтрока.ПриходКасса = Стр.СуммаПрихода;
					
				ИначеЕсли ЗначениеЗаполнено(Стр.ТипКонтрагента) И СокрЛП(Стр.ТипКонтрагента) = "Офис" Тогда // приход офис
					
					НоваяСтрока = ПараметрыОтчета.Итоги.ОстаткиОбороты.Добавить();
					НоваяСтрока.Фирма = СокрЛП(Организация);
					НоваяСтрока.ПриходОфис = Стр.СуммаПрихода;
					
					НоваяСтрока = ПараметрыОтчета.Итоги.ОборотыОфис.Добавить();
					НоваяСтрока.Фирма = СокрЛП(Организация);
					НоваяСтрока.СуммаПриход = Стр.СуммаПрихода;
					
				ИначеЕсли ЗначениеЗаполнено(Стр.ТипКонтрагента) И СокрЛП(Стр.ТипКонтрагента) = "Фирмы универсама" Тогда // приход универсам
					
					НоваяСтрока = ПараметрыОтчета.Итоги.ОстаткиОбороты.Добавить();
					НоваяСтрока.Фирма = СокрЛП(Организация);
					НоваяСтрока.ПриходУниверс = Стр.СуммаПрихода;
					
				ИначеЕсли Лев(Стр.КорСчет, 2) = "51" Тогда	// 

				ИначеЕсли Лев(Стр.КорСчет, 2) = "76" Или Лев(Стр.КорСчет, 2) = "66" Или Лев(Стр.КорСчет, 2) = "75" Тогда	// ПриходУчредит
					НоваяСтрока = ПараметрыОтчета.Итоги.ОстаткиОбороты.Добавить();
					НоваяСтрока.Фирма = СокрЛП(Организация);
					НоваяСтрока.ПриходУчредит = Стр.СуммаПрихода;

				ИначеЕсли Лев(Стр.КорСчет, 2) = "57" Тогда	// Приход57
					НоваяСтрока = ПараметрыОтчета.Итоги.ОстаткиОбороты.Добавить();
					НоваяСтрока.Фирма = СокрЛП(Организация);
					НоваяСтрока.Приход57 = Стр.СуммаПрихода;
					
				ИначеЕсли (Лев(Стр.КорСчет, 2) = "62" И ПараметрыОтчета.СвоиФирмы.Найти(Стр.КорСубконтоИНН, "ИНН") = Неопределено // ПриходВНД
						И СтрНайти(ВРег(Стр.КорСубконто), "РЕКЛ") <> 0)
					ИЛИ (Лев(Стр.КорСчет, 5) = "62.05") Тогда
					НоваяСтрока = ПараметрыОтчета.Итоги.ОстаткиОбороты.Добавить();
					НоваяСтрока.Фирма = СокрЛП(Организация);
					НоваяСтрока.ПриходВНД = Стр.СуммаПрихода;

				ИначеЕсли Лев(Стр.КорСчет, 5) = "60.01"		// ПриходВозврат
					И ПараметрыОтчета.СвоиФирмы.Найти(Стр.КорСубконтоИНН, "ИНН") = Неопределено
					И СтрНайти(ВРег(Стр.КорСубконто), "РЕКЛ") = 0
					И СтрНайти(ВРег(Стр.КорСубконто), "ТИМОША") = 0
					И СтрНайти(ВРег(Стр.КорСубконто), "БЛЕЙД") = 0
					И СтрНайти(ВРег(Стр.СтатьяДС), "ВОЗВРАТ") > 0 Тогда
					НоваяСтрока = ПараметрыОтчета.Итоги.ОстаткиОбороты.Добавить();
					НоваяСтрока.Фирма = СокрЛП(Организация);
					НоваяСтрока.ПриходВозврат = Стр.СуммаПрихода;

				ИначеЕсли Лев(Стр.КорСчет, 5) = "60.02"		// ПриходСТорно
					И ПараметрыОтчета.СвоиФирмы.Найти(Стр.КорСубконтоИНН, "ИНН") = Неопределено
					И СтрНайти(ВРег(Стр.КорСубконто), "РЕКЛ") = 0
					И СтрНайти(ВРег(Стр.КорСубконто), "ТИМОША") = 0
					И СтрНайти(ВРег(Стр.КорСубконто), "БЛЕЙД") = 0
					...
					НоваяСтрока = ПараметрыОтчета.Итоги.ОстаткиОбороты.Добавить();
					НоваяСтрока.Фирма = СокрЛП(Организация);
					НоваяСтрока.ПриходСТорно = Стр.СуммаПрихода;
					
				ИначеЕсли Не Лев(Стр.КорСчет, 2) = "57" 								// ПриходМальч
					И ПараметрыОтчета.СвоиФирмы.Найти(Стр.КорСубконтоИНН, "ИНН") = Неопределено
					И СтрНайти(ВРег(Стр.КорСубконто), "ТИМОША") <> 0 Тогда
					НоваяСтрока = ПараметрыОтчета.Итоги.ОстаткиОбороты.Добавить();
					НоваяСтрока.Фирма = СокрЛП(Организация);
					НоваяСтрока.ПриходМальч = Стр.СуммаПрихода;
					
					НоваяСтрока = ПараметрыОтчета.Итоги.ОборотыМальч.Добавить();
					НоваяСтрока.Фирма = СокрЛП(Организация);
					НоваяСтрока.СуммаПриход = Стр.СуммаПрихода;

				ИначеЕсли Лев(Стр.КорСчет, 2) = "60" ИЛИ Лев(Стр.КорСчет, 2) = "62" // ПриходУниверс
					И ПараметрыОтчета.СвоиФирмы.Найти(Стр.КорСубконтоИНН, "ИНН") <> Неопределено Тогда
					НоваяСтрока = ПараметрыОтчета.Итоги.ОстаткиОбороты.Добавить();
					НоваяСтрока.Фирма = СокрЛП(Организация);
					НоваяСтрока.ПриходУниверс = Стр.СуммаПрихода;
					
				ИначеЕсли (Не Лев(Стр.КорСчет, 2) = "57" 							// ПриходОфис
					И ПараметрыОтчета.СвоиФирмы.Найти(Стр.КорСубконтоИНН, "ИНН") = Неопределено
					И СтрНайти(ВРег(Стр.КорСубконто), "БЛЕЙД") <> 0)
					ИЛИ (Лев(Стр.КорСчет, 2) = "62" И СтрНайти(ВРег(Стр.СтатьяДС), "АРЕНДА") > 0) Тогда
					НоваяСтрока = ПараметрыОтчета.Итоги.ОстаткиОбороты.Добавить();
					НоваяСтрока.Фирма = СокрЛП(Организация);
					НоваяСтрока.ПриходОфис = Стр.СуммаПрихода;
				...
				ИначеЕсли Лев(Стр.КорСчет, 2) = "62"	// ПриходРеализация
					И ПараметрыОтчета.СвоиФирмы.Найти(Стр.КорСубконтоИНН, "ИНН") = Неопределено
					И СтрНайти(ВРег(Стр.КорСубконто), "ТИМОША") = 0
					И СтрНайти(ВРег(Стр.КорСубконто), "БЛЕЙД") = 0
					И СтрНайти(ВРег(Стр.СтатьяДС), "АРЕНДА") = 0 Тогда
					НоваяСтрока = ПараметрыОтчета.Итоги.ОстаткиОбороты.Добавить();
					НоваяСтрока.Фирма = СокрЛП(Организация);
					НоваяСтрока.ПриходРеализация = Стр.СуммаПрихода;
					
				Иначе
					НоваяСтрока = ПараметрыОтчета.Итоги.ОстаткиОбороты.Добавить();	// ПриходПрочие
					НоваяСтрока.Фирма = СокрЛП(Организация);
					НоваяСтрока.ПриходПрочие = Стр.СуммаПрихода;
	...
	Запрос.Параметры.Вставить("ДатаОкончания", Новый Граница(КонецДня(ПараметрыОтчета.КонецПериода), ВидГраницы.Включая));
	Запрос.Параметры.Вставить("Организация",   Организация.ИНН);
	Запрос.Параметры.Вставить("Счет", РегистрыСведений.Меппинг.ПолучитьЗамену(Организация, "62"));  // РасчетыСПокупателямиИЗаказчиками
	Запрос.Параметры.Вставить("КорСчет", РегистрыСведений.Меппинг.ПолучитьЗамену(Организация, "51"));  // РасчетныеСчета
	Запрос.ТекстЗапроса = "
		|ВЫБРАТЬ
		|	Хозрасчетный.Ссылка КАК Счет
		|ПОМЕСТИТЬ ВТСчета
	...
	Если НЕ Ответ.Ошибка Тогда
		Если Ответ.Результат.Количество() > 0 Тогда
			...
			ОбластьМакета.Параметры.СуммаПрихода=ТаблицаПоступлений.Итог("СуммаПрихода");//ИтСумПоступлений+ИтСуммаДоп;
			ТабличныйДокумент.Вывести(ОбластьМакета);
...
Процедура ПоступлениеТоваров(Прокси, ПараметрыОтчета, Организация, Группа, Курс)
	
	Ответ = Неопределено;
	Если ЗатратыСерверПереопределяемый.ЭтоЖасмин(Организация) Тогда
		...
		КонецЕсли;			
	ИначеЕсли ЗатратыСерверПереопределяемый.ЭтоБайкалЯрисПосейдон(Организация) Тогда
	...
	Запрос.ТекстЗапроса = "ВЫБРАТЬ
		...
		|		ПО (УпрАналитика1.Объект = Контрагенты.Ссылка)
		|		ЛЕВОЕ СОЕДИНЕНИЕ ВТДопСвойство КАК УпрАналитика2
		|		ПО (УпрАналитика2.Объект = Контрагенты.Ссылка.Родитель)
		|		ЛЕВОЕ СОЕДИНЕНИЕ ВТДопСвойство КАК УпрАналитика3
		|		ПО (УпрАналитика3.Объект = Контрагенты.Ссылка.Родитель.Родитель)
		|		ЛЕВОЕ СОЕДИНЕНИЕ ВТДопСвойство КАК УпрАналитика4
		|		ПО (УпрАналитика4.Объект = Контрагенты.Ссылка.Родитель.Родитель.Родитель)
		|		ЛЕВОЕ СОЕДИНЕНИЕ ВТДопСвойство КАК УпрАналитика5
		|		ПО (УпрАналитика5.Объект = Контрагенты.Ссылка.Родитель.Родитель.Родитель.Родитель)
		|ГДЕ
		|	НЕ Контрагенты.ЭтоГруппа
		|	И (ВЫБОР
		|				КОГДА ВЫБОР
		|						КОГДА НЕ УпрАналитика1.Значение ЕСТЬ NULL
		|							ТОГДА УпрАналитика1.Значение.Наименование
		|						ИНАЧЕ ВЫБОР
		|								КОГДА НЕ УпрАналитика2.Значение ЕСТЬ NULL
		|									ТОГДА УпрАналитика2.Значение.Наименование
		|								ИНАЧЕ ВЫБОР
		|										КОГДА НЕ УпрАналитика3.Значение ЕСТЬ NULL
		|											ТОГДА УпрАналитика3.Значение.Наименование
		|										ИНАЧЕ ВЫБОР
		|												КОГДА НЕ УпрАналитика4.Значение ЕСТЬ NULL
		|													ТОГДА УпрАналитика4.Значение.Наименование
		|												ИНАЧЕ ВЫБОР
		|														КОГДА НЕ УпрАналитика5.Значение ЕСТЬ NULL
		|															ТОГДА УпрАналитика5.Значение.Наименование
		|														ИНАЧЕ НЕОПРЕДЕЛЕНО
		|													КОНЕЦ
		|											КОНЕЦ
		|									КОНЕЦ
		|							КОНЕЦ
		|					КОНЕЦ = ""Поставщики товара""
		|					ТОГДА ИСТИНА
		|				ИНАЧЕ ЛОЖЬ
		|			КОНЕЦ
		|			ИЛИ (Контрагенты.Наименование = &ГруппаКонтрагентов
		|				ИЛИ Контрагенты.Родитель.Наименование = &ГруппаКонтрагентов
		|				ИЛИ Контрагенты.Родитель.Родитель.Наименование = &ГруппаКонтрагентов
		|				ИЛИ Контрагенты.Родитель.Родитель.Родитель.Наименование = &ГруппаКонтрагентов))
		|
	...
	Ответ.Результат = ПересчитатьТаблицуПоКурсу(Ответ.Результат, "СуммаТоваров", Курс);
