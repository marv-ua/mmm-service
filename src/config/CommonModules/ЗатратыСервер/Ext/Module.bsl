...
Функция Услуги(Прокси, ПараметрыОтчета, Организация, ТабличныйДокумент, Макет, Курс)
...
Процедура Проверка(Прокси, ТабличныйДокумент, Макет, ПараметрыОтчета, Организация, Курс)
