...
Процедура ФоновоеЗаполненияЗавершено(Результат, ДополнительныеПараметры) Экспорт
	...
	ИначеЕсли Результат.Статус = "Выполнено" Тогда
		...
		ПолноеИмяФайла = КаталогДокументов()+"\ОтчетыНМУ\"+Формат(Объект.ПериодРегистрации, "ДФ=гггг_ММ_")+СокрЛП("НМУ_"+ИмяОрганизации)+"_"+Формат(ТекущаяДата(), "ДФ=dd-MM-yy")+".xls";
