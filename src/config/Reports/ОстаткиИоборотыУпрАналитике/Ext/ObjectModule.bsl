...
Функция ТекстЗапроса()
	...
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	|	ЗНАЧЕНИЕ(ПланСчетов.Хозрасчетный.РасчетыСПоставщикамиИПодрядчиками) КАК Счет
	|ПОМЕСТИТЬ ВТСчета
	|
	|ОБЪЕДИНИТЬ ВСЕ
	|
	...
	|		ПО (УпрАналитика1.Объект = ХозрасчетныйОстаткиИОбороты.Субконто1)
	|		ЛЕВОЕ СОЕДИНЕНИЕ ВТДопСвойство КАК УпрАналитика2
	|		ПО (УпрАналитика2.Объект = ХозрасчетныйОстаткиИОбороты.Субконто1.Родитель)
	|		ЛЕВОЕ СОЕДИНЕНИЕ ВТДопСвойство КАК УпрАналитика3
	|		ПО (УпрАналитика3.Объект = ХозрасчетныйОстаткиИОбороты.Субконто1.Родитель.Родитель)
	|		ЛЕВОЕ СОЕДИНЕНИЕ ВТДопСвойство КАК УпрАналитика4
	|		ПО (УпрАналитика4.Объект = ХозрасчетныйОстаткиИОбороты.Субконто1.Родитель.Родитель.Родитель)
	|		ЛЕВОЕ СОЕДИНЕНИЕ ВТДопСвойство КАК УпрАналитика5
	|		ПО (УпрАналитика5.Объект = ХозрасчетныйОстаткиИОбороты.Субконто1.Родитель.Родитель.Родитель.Родитель)
	|
	|ОБЪЕДИНИТЬ ВСЕ
	|
	|ВЫБРАТЬ
