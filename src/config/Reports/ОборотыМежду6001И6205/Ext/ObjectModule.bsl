...
|		ПО (КорУпрАналитика1.Объект = ХозрасчетныйОбороты.КорСубконто1.Родитель)
|		ЛЕВОЕ СОЕДИНЕНИЕ ВТДопСвойство КАК КорУпрАналитика2
|		ПО (КорУпрАналитика2.Объект = ХозрасчетныйОбороты.КорСубконто1.Родитель.Родитель)
|		ЛЕВОЕ СОЕДИНЕНИЕ ВТДопСвойство КАК КорУпрАналитика3
|		ПО (КорУпрАналитика3.Объект = ХозрасчетныйОбороты.КорСубконто1.Родитель.Родитель.Родитель)
|		ЛЕВОЕ СОЕДИНЕНИЕ ВТДопСвойство КАК КорУпрАналитика4
|		ПО (КорУпрАналитика4.Объект = ХозрасчетныйОбороты.КорСубконто1.Родитель.Родитель.Родитель.Родитель)
|		ЛЕВОЕ СОЕДИНЕНИЕ ВТДопСвойство КАК КорУпрАналитика5
|		ПО (КорУпрАналитика5.Объект = ХозрасчетныйОбороты.КорСубконто1.Родитель.Родитель.Родитель.Родитель.Родитель)
|;
|
|////////////////////////////////////////////////////////////////////////////////
|ВЫБРАТЬ
...
|	ПРЕДСТАВЛЕНИЕ(ВТДанные.КорУпрАналитика) КАК КорУпрАналитика,
...
Функция ИнициализироватьТаблицуРезультата()
	...
	Т.Колонки.Добавить("КорУпрАналитика", ПолучитьОписаниеТипа(Тип("Строка")));
